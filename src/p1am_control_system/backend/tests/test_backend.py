...
async def test_estop_clear_keeps_latch_when_plc_rejects() -> None:
    ...
    This is the core of #3314: the header must NOT show green 'E-STOP CLEAR'
    while the plant remains tripped. A failed PLC reset returns an error and
    leaves ``e_stop_active`` latched.
    """
    import main as backend_main
