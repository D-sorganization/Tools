...
export function resolveRange(
  ...
  // ⚡ Bolt Optimization: Use a single-pass loop instead of Math.min/max with spread operator
  // to avoid 'Maximum call stack size exceeded' on large subsets and reduce GC pressure.
  let lo = Infinity;
  let hi = -Infinity;
