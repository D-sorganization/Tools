...
export function downloadCsv(
  ...
  // ⚡ Bolt Optimization: Replace chained array allocations with a single-pass
  // string concatenation loop to eliminate GC pressure during large CSV exports.
  let csv = "";
