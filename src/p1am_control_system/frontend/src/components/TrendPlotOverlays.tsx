...
export const TrendCrosshair: React.FC<{
  ...
  // ⚡ Bolt Optimization: Replace multiple .reduce() and .map() calls with a single-pass loop
  // to avoid closure allocations and intermediate arrays in high-frequency pointer move renders
  const lines = [xLabel];
