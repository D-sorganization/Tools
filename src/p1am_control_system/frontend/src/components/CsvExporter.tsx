    ...
    <div style={{ borderTop: "1px solid var(--panel-border)", paddingTop: "1rem" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        <div className="input-group">
          <label htmlFor={tagsInputId} className="input-label">Tags (comma-separated)</label>
          <input
            id={tagsInputId}
            type="text"
        ...
        <div className="input-group">
          <label htmlFor={startInputId} className="input-label">Start Time</label>
          <input
            id={startInputId}
            type="datetime-local"
            className="form-input"
        ...
        <div className="input-group">
          <label htmlFor={endInputId} className="input-label">End Time</label>
          <input
            id={endInputId}
            type="datetime-local"
            className="form-input"
