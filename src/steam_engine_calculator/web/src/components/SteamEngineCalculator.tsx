...
function calculateSteamPropertiesFallback(
  ...
  const speedOfSound =
    phase === "liquid" ? 1500 : Math.sqrt(1.3 * R * temperature);
        ...
        <div className="space-y-6">
          ...
          <Section title="Input Parameters">
            ...
            <div className="flex items-center gap-4 mb-4">
              <label className="w-24 text-sm" style={{ color: colors.text }}>
                Temperature
              </label>
              <input
                type="number"
                ...
                style={{
                  backgroundColor:
                    mode === "sat_p" ? colors.surface1 : colors.surface0,
                  color: colors.text,
                  border: `1px solid ${colors.surface1}`,
                }}
              />
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                style={{
                  backgroundColor:
                    mode === "sat_t" ? colors.surface1 : colors.surface0,
                  color: colors.text,
                  border: `1px solid ${colors.surface1}`,
                }}
              />
              <select
                ...
                onChange={(e) =>
                  setPressureUnit(
                    e.target.value as "Pa" | "kPa" | "bar" | "MPa",
                  )
                }
                className="w-20 px-2 py-2 rounded"
                style={{
...
function MetricCard({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: colors.surface0 }}
    >
      <p className="text-xs mb-1" style={{ color: colors.subtext0 }}>
        {label}
      </p>
      ...
      {subvalue && (
        <p className="text-xs mt-1" style={{ color: colors.subtext0 }}>
          {subvalue}
        </p>
      )}
    </div>
