    ...
    components.extend(
        [
            VesselComponent(
                ...
                thermal_conductivity_w_per_mk=electrode_properties.thermal_conductivity_w_per_mk,  # noqa: E501
                thermal_expansion_um_per_m_c=electrode_properties.thermal_expansion_um_per_m_c,  # noqa: E501
