...
from ...widget_factory import (  # noqa: E402
    create_checkbox,
    create_combobox,
...
class ElectrodeAdvisorWidget(QWidget):
    ...
    def _create_glass_properties_section(self, parent_layout: QVBoxLayout) -> None:
        ...
        self.glass_integration_checkbox.setToolTip(
            "Connect to external glass properties calculator for accurate conductivity calculations"
        )
    ...
    # Keep existing helper methods for drawing vessel, metal layer, glass layer, etc.
