"""StateAndExportMixin -- state management and export methods.

Handles get/restore state, electrode depth setting, electrical measurement
injection, and exporting results/plots/charts.
"""
...
class StateAndExportMixin:
    """Mixin providing state management and export methods.

    Expected to be mixed into a QWidget subclass that defines:
    - ``self.phase_inputs``, ``self.depth_inputs``
    - ``self.calculation_results``
    - Various widget attributes
    """
