...
describe("VideoUploader", () => {
  ...
  describe("Rendering", () => {
    it("should render upload area", () => {
      ...
      expect(
        screen.getByText(/Drop your video here, or click to browse/i),
      ).toBeInTheDocument();
    });
    ...
    it("should display supported formats", () => {
      ...
      expect(
        screen.getByText(/Supported formats: MP4, WebM, OGG, MOV, AVI, MKV/i),
      ).toBeInTheDocument();
    });
  ...
  describe("Drag and Drop", () => {
    ...
    it("should show error when dropping non-video file", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Please drop a video file/i),
        ).toBeInTheDocument();
      });
      expect(onVideoUpload).not.toHaveBeenCalled();
    });
