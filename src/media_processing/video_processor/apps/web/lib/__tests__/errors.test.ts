  ...
  describe("getUserMessage", () => {
    ...
    it("should not expose internal error details", () => {
      const error = new VideoProcessingError(
        "FFmpeg crash: segfault at 0x123456",
      );
      const message = getUserMessage(error);
...
describe("Assert Functions", () => {
  ...
  describe("assertNumber", () => {
    ...
    it("should throw for NaN", () => {
      ...
      expect(() => assertNumber(NaN, "number")).toThrow(
    ...
    it("should enforce minimum value", () => {
      ...
      expect(() => assertNumber(5, "number", { min: 10 })).toThrow(
        ValidationError,
      );
      expect(() => assertNumber(5, "number", { min: 10 })).toThrow(
        "must be at least 10",
    ...
    it("should enforce maximum value", () => {
      ...
      expect(() => assertNumber(5, "number", { max: 3 })).toThrow(
        ValidationError,
      );
      expect(() => assertNumber(5, "number", { max: 3 })).toThrow(
        "must be at most 3",
    ...
    it("should enforce range", () => {
      expect(() =>
        assertNumber(5, "number", { min: 0, max: 10 }),
      ).not.toThrow();
  ...
  describe("assertString", () => {
    ...
    it("should enforce minimum length", () => {
      expect(() =>
        assertString("hello", "text", { minLength: 3 }),
      ).not.toThrow();
    ...
    it("should enforce maximum length", () => {
      ...
      expect(() =>
        assertString("hello world", "text", { maxLength: 5 }),
      ).toThrow(ValidationError);
      expect(() =>
        assertString("hello world", "text", { maxLength: 5 }),
    ...
    it("should enforce length range", () => {
      expect(() =>
        assertString("hello", "text", { minLength: 3, maxLength: 10 }),
      ).not.toThrow();
      expect(() =>
        assertString("hi", "text", { minLength: 3, maxLength: 10 }),
      ).toThrow();
      expect(() =>
        assertString("hello world!!", "text", { minLength: 3, maxLength: 10 }),
      ).toThrow();
    });
  });
});
