...
class TestCancelJob:
    ...
    def test_cancel_completed_job_returns_status_value_in_detail(
    ...
    def test_cancel_failed_job_returns_status_value_in_detail(
        self, client, api_module
    ) -> None:
    ...
    def test_cancel_queued_job_succeeds(self, client, api_module) -> None:
...
class TestStartProcessing:
    ...
    def test_start_processing_non_queued_returns_status_value(
        self, client, api_module
    ) -> None:
    ...
    def test_start_processing_queued_job_returns_new_status(
        self, client, api_module
    ) -> None:
    ...
    def test_start_processing_not_found_returns_404(self, client) -> None:
