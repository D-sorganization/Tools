"""Reference-frame conversion operations shared across UIs.

Provides educational outputs for:
- twist frame conversion via adjoint
- homogeneous transform build/invert
- so(3) <-> SO(3) maps
"""
...
def compute_twist_frame_conversion(transform: Any, twist: Any) -> ReferenceFrameResult:
    ...
    adjoint_matrix = adjoint_representation(transform_matrix)
