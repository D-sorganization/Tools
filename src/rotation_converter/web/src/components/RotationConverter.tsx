            ...
            <div className="bg-slate-800 rounded-lg p-6 space-y-4 text-white">
                        ...
                        {['w', 'x', 'y', 'z'].map((axis, i) => (
                            <div key={axis}>
                                ...
                                <input
                                    ...
                                    step="0.01"
                                    className="w-full bg-slate-700 rounded px-2 py-1 text-sm border border-slate-600 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 focus-visible:ring-offset-slate-700"
                                />
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="xyz"
                                className="w-full bg-slate-700 rounded px-3 py-2 text-sm border border-slate-600 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 focus-visible:ring-offset-slate-700"
                            />
                        </div>
                ...
                <div className="pt-4">
                    <button
                        ...
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-800"
                    >
                        Compute Equivalents
                    </button>
                </div>
