      ...
      <div className="bg-slate-800 rounded-lg p-6 space-y-4 text-white">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-slate-700 rounded px-3 py-2 border border-slate-600 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 focus-visible:ring-offset-slate-700"
          >
              ...
              {transform.map((row, i) =>
                row.map((entry, j) => (
                  <input
                    ...
                    className="bg-slate-700 rounded px-2 py-1 text-sm border border-slate-600 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 focus-visible:ring-offset-slate-700"
                  />
                )),
              )}
            </div>
