...
def get_readiness_status() -> dict[str, Any]:
    ...
    try:
        ...
        checks["packages"] = {"healthy": False, "error": "Required packages failed to import"}
...
def register_health_endpoints(app: Any) -> None:
    ...
    def health() -> tuple[dict[str, Any], int]:
        ...
        try:
            ...
            return jsonify({"status": "error", "error": "An internal error occurred during health check."}), 503
    ...
    def ready() -> tuple[dict[str, Any], int]:
        ...
        try:
            ...
            return jsonify({"status": "error", "error": "An internal error occurred during readiness check."}), 503
