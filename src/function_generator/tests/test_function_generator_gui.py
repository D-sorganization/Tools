    ...
    def test_widget_creation(self, mock_qt_app) -> None:
        ...
        try:
            ...
            with patch.object(FunctionGeneratorWidget, "_init_ui", return_value=None):
                with patch.object(FunctionGeneratorWidget, "_apply_styling", return_value=None):
                    with patch.object(FunctionGeneratorWidget, "_connect_signals", return_value=None):
                        with patch.object(FunctionGeneratorWidget, "_generate_signal", return_value=None):
