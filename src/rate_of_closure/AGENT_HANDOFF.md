...
`feat/4626-streaming-ensemble` through `12ab5bb90` (PR #4628) adds scalar moments,
...
The latest fix closes lazy imports, PyQt accessibility, Ruff/Mypy, Upstream's build hook,
