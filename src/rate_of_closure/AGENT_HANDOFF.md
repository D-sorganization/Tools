...
performance flake under xdist contention. The fixed 0.5 s render-work budget is
now measured with the process CPU clock, with the 200 ms cadence unchanged.
