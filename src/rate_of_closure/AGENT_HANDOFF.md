...
screening views, not causal anatomy, human validation, or coaching authority.
Local serial evidence passes 97 Python and 107 React tests, type/lint, module
inventory, and design-manual governance.
