...
adapter matrix remains two verified / ten explicitly unavailable. The exact CI repair retains UpstreamDrift's imported BunkerShot and double-pendulum packages in the shallow contract checkout. The ledger is 26 verified / 5 partial. Protected CI and remote-main proof remain.
