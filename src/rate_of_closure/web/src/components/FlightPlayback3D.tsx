  ...
  return (
    <section className="space-y-3" aria-label="3D ball-flight playback">
      ...
      <canvas
        ...
        className="w-full touch-none rounded-lg border border-slate-800 bg-slate-950/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500"
        onPointerDown={(event) => {
