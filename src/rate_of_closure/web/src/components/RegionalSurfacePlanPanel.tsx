  ...
  return (
    <label className="flex min-w-0 flex-col gap-1 text-xs text-slate-400">
      ...
      <input type="number" value={Number.isNaN(props.value) ? "" : props.value}
        ...
        className="rounded-md border border-slate-700 bg-slate-950 px-2 py-1.5 text-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:border-sky-500 aria-[invalid=true]:border-rose-500" />
    </label>
  );
}
    ...
    <div className="mt-3 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
      <label className="flex flex-col gap-1 text-xs text-slate-400">
        ...
        <input value={props.value.surface_id}
          ...
          className="rounded-md border border-slate-700 bg-slate-950 px-2 py-1.5 text-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:border-sky-500" />
      </label>
