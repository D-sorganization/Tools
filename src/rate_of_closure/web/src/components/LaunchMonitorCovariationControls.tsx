...
function IdentityControls({ controller }: { controller: CovariationController }) {
...
export function LaunchMonitorCovariationControls({ controller }: {
  controller: CovariationController;
}) {
  return <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
    <IdentityControls controller={controller} />
