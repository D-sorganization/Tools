...
class TestCollectIssues:
    def test_valid_spec_has_no_issues(self) -> Any:
        issues = collect_issues(VALID_SPEC)
        errors = [i for i in issues if i.severity == "error"]
        assert errors == []

    def test_non_dict_spec_returns_issue(self) -> Any:
        issues = collect_issues("not a dict")
        assert len(issues) == 1
        assert "mapping" in issues[0].message.lower()

    def test_missing_project_id(self) -> Any:
    ...
    def test_missing_project_title(self) -> Any:
        spec = {
            "project": {"id": "P001"},
    ...
    def test_empty_equipment_list(self) -> Any:
        spec = {
    ...
    def test_equipment_missing_id(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
    ...
    def test_duplicate_equipment_id(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
            "equipment": [
                {"id": "V101", "w": 5.0, "h": 5.0},
    ...
    def test_non_positive_width_height(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
    ...
    def test_instrument_missing_id(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
    ...
    def test_duplicate_instrument_id(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
            "equipment": [{"id": "V101", "w": 5.0, "h": 5.0}],
    ...
    def test_stream_unknown_from_equipment(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
            "equipment": [{"id": "V101", "w": 5.0, "h": 5.0}],
    ...
    def test_stream_unknown_to_equipment(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
            "equipment": [{"id": "V101", "w": 5.0, "h": 5.0}],
    ...
    def test_control_loop_missing_measurement(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
            "equipment": [{"id": "V101", "w": 5.0, "h": 5.0}],
    ...
    def test_control_loop_unknown_measurement(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
            "equipment": [{"id": "V101", "w": 5.0, "h": 5.0}],
    ...
    def test_control_loop_unknown_final_element(self) -> Any:
        spec = {
            "project": {"id": "P001", "title": "T"},
            "equipment": [{"id": "V101", "w": 5.0, "h": 5.0}],
            "instruments": [{"id": "FT101"}],
    ...
    def test_stream_no_from_or_to_key(self) -> Any:
