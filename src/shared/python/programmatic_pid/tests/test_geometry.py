...
class TestDedupePoints:
    ...
    def test_single_point(self) -> Any:
        assert dedupe_points([(1.0, 2.0)]) == [(1.0, 2.0)]

    def test_nearly_equal_points_removed(self) -> Any:
...
class TestFindFreeRegion:
    def test_empty_occupied_returns_region(self) -> Any:
    ...
    def test_returns_non_overlapping_region(self) -> Any:
    ...
    def test_custom_search_origin(self) -> Any:
