...
Numerical shaft #5133 is merged from 0cd6dce22 as 2c9a8d6c; physical #5072 remains open. T4 numerical review child #5145 adds private contact geometry/work, full-tensor body response and instantaneous shaft/ball coupling. All 323 Windows/Linux controls pass at ec863402f; five production files pass NumPy-aware mypy. The shared spatial-inertia kernel preserves the old club entry-point signature; the shared mass solve preserves shaft behavior. Existing 99 golf-club and 228 swing API records are unchanged. Legacy T2 force/event equations are retained. Full trajectories, face modes, convergence and held-out physical/acoustic evidence remain under #5073. See [current evidence](../../../../docs/development/impact-acoustics/SPATIAL_CONTACT_RESULTS.json) and the repository impact PROGRESS.md; private-consumer access and reviewed downstream pin qualification remain outstanding.
