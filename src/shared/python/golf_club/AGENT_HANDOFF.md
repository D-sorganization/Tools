...
T3 #5072: finite-grip balance/FRF/spectra and homogeneous decay are published; residual-forced affine response is published at d5d1e6537 through all normal hooks. New constant gripped-model assembly explicitly prescribes frame inputs/anchors/loads, retains residual and owned reference state, and shares work-conjugate scaling with spectra. All 57 focused Windows and 824 combined Linux golf/signal/API tests pass (two optional CAD skips). Scoped mypy/Ruff pass; all nine final gates and repository Ruff pass; normal publication remains. See CONSTANT_GRIPPED_MODEL.md, AFFINE_RESPONSE.md and PROGRESS.md for full history. Classifier #5103 remains required before combined delivery. Transient/bandwidth, nonlinear/moving work, contact, radiation/calibration and blinded validation remain open; no physical stability or sweetness is qualified.
