...
T3 #5072: constant gripped operating models published at 36aae1d578 through all normal hooks (824 Linux golf/signal/API passes). New affine transient motion reuses plant/input validation and scaling; neutral/defective/growing states are retained. TDD includes the initial missing-module failure and a repaired positive-time underflow failure. All 88 focused Windows tests and actual mypy/Ruff pass; 860 Linux golf/signal/API tests pass (two optional CAD skips), with all nine gates and repository Ruff passing. Normal publication remains. See AFFINE_TRANSIENT.md and PROGRESS.md. Classifier #5103 is still required before combined delivery; #5114 has 2 isolated and 21 mixed Qt passes without reproducing the old stall. Transient/bandwidth, nonlinear/moving work, contact, radiation/calibration and blinded validation remain open. No physical stability or sweetness qualification.
