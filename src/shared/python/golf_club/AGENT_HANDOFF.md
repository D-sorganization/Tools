...
T3 #5072: affine transient 09d8e59cf is published through all normal hooks with 860 Linux golf/signal/API passes. New explicit real Galerkin reduction preserves virtual work, separate G/C, nonsymmetric K and both plant validations. Missing-module RED preceded implementation; 81 combined Galerkin/transient/operating cases, actual mypy and repository Ruff pass. Modal refinement of the finite-grip rod and omitted-resonance/instability controls are in GALERKIN_REDUCTION.md. Broader checks and publication remain. Classifier #5103 published c0163768c; subsequent docs-only main integration remains. Modal/mesh/FRF bandwidth, moving nonlinear work, contact, radiation/calibration and blinded validation remain open. No physical stability or sweetness qualification.
