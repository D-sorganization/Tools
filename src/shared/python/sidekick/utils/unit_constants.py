...
__all__ = [
    ...
    "BTU_PER_LB_TO_J_PER_KG",
    "BTU_PER_LB_TO_MJ_PER_KG",
    ...
    "KG_PER_CU_METER_TO_KG_PER_CU_METER",
    ...
    "SQ_FOOT_PER_SECOND_TO_SQ_METER_PER_SECOND",
    "SQ_FOOT_TO_SQ_METER",
    "SQ_INCH_TO_SQ_METER",
    "SQ_KILOMETER_TO_SQ_METER",
    "SQ_METER_PER_SECOND_TO_SQ_METER_PER_SECOND",
    "SQ_METER_TO_SQ_METER",
...
FOOT_POUND_TO_JOULE: Final[float] = 1.3558179483314004
FOOT_POUND_TO_NEWTON_METER: Final[float] = FOOT_POUND_TO_JOULE
POUND_FORCE_INCH_TO_NEWTON_METER: Final[float] = FOOT_POUND_TO_NEWTON_METER / 12.0
