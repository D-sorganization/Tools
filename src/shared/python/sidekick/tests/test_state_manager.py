...
def test_initialization(manager: StateManager, tmp_path: Path) -> Any:
...
def test_protect_unprotect_state(manager: StateManager) -> Any:
...
def test_save_load_state(manager: StateManager) -> Any:
...
def test_save_state_with_protection(manager: StateManager) -> Any:
    state_data = {"foo": "bar"}
...
def test_export_import_state(manager: StateManager, tmp_path: Path) -> Any:
...
def test_save_load_session(manager: StateManager) -> Any:
...
def test_cleanup_backups(manager: StateManager, tmp_path: Path) -> Any:
...
def test_json_serializer(manager: StateManager) -> Any:
    from pathlib import Path
...
def test_load_state_invalid_format(manager: StateManager, tmp_path: Path) -> Any:
...
def test_permission_error_save_load(manager: StateManager) -> Any:
...
def test_singleton_get_state_manager(tmp_path: Path) -> Any:
...
def test_delete_state_not_found(manager: StateManager) -> Any:
    assert manager.delete_state("does_not_exist") is False


def test_protect_state_existing(manager: StateManager) -> Any:
...
def test_list_states_errors_and_cache(manager: StateManager, tmp_path: Path) -> Any:
...
def test_unprotect_permission_error(manager: StateManager) -> Any:
...
def test_delete_state_permission_error(manager: StateManager) -> Any:
