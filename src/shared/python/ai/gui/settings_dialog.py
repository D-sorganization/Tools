...
class ProviderConfigWidget(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        if self._info["requires_key"]:
            ...
            # Only Ollama needs a host configuration
...
class AISettingsDialog(QDialog):
    ...
    def _create_provider_tab(self) -> QWidget:
        ...
        # Cost note
        cost_label = QLabel(
            "<b>💡 Tip:</b> Local models (such as those run through Ollama) are completely FREE and run on your machine. "
            "Cloud models (such as OpenAI, Anthropic, Gemini) may incur usage costs."
        )
