...
Last updated: 2026-09-08. Update with each implementation PR and main delivery.
...
PR #5084 introduced ingestion and spectral estimates. The current branch
`fix/5074-waveform-spectral-contracts` repairs 16 reproduced boundary failures;
...
1. Complete normal protected delivery; API/Linux and all nine manual gates pass.
2. Add versioned calibration/acquisition identity and supported-bin complex FRF.
