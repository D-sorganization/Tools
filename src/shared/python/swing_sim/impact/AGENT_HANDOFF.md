...
- Event child #5151 is PR#5152 and passes386 Windows/Linux controls at tree4e1b19810; shared chart/geometry ports, independent piecewise event/work reference and strict SI/budget/history guards are retained. CI ndarray return typing repair is in progress; see docs/ci-failures/impact5151-20260910.md and NORMAL_EVENT_RESULTS.json; protected review, friction/modes and physical/acoustic qualification remain.
