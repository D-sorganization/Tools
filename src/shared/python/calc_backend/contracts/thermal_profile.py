...
class ThermalProfileRequest(BaseModel):
    ...
    heat_loss_coeff_w_per_k: float = Field(..., ge=0, description="Heat loss coefficient [W/K]")
    ...
    step_time_s: float = Field(default=1800.0, ge=0, description="Step time for step profile [s]")
