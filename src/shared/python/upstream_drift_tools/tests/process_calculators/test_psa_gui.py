...
def test_sensitivity_plot_widget(mock_calc, dummy_qapp):
    ...
    mock_sensitivity = {
        "h2_recovery": [[70.0, 75.0, 80.0], [71.0, 76.0, 81.0]],
        "net_product": [[400.0, 450.0, 500.0], [410.0, 460.0, 510.0]],
    }
...
def test_psa_main_window_initialization(mock_show, dummy_qapp):
    ...
    with patch("upstream_drift_tools.process_calculators.psa_package.psa_gui.PSAModel"):
