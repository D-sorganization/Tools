...
class TestODESolver:
    ...
    def test_solve_without_t_eval(self) -> Any:
        solver = self._make_solver()
    ...
    def test_plot_calls_plt_show(self) -> Any:
        solver = self._make_solver()
