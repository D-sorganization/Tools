...
class TestConvertDispatch:
    ...
    def test_convert_returns_warnings_field(self, svc) -> Any:
...
class TestAddUnit:
    ...
    def test_add_unit_unknown_category_raises(self, svc) -> Any:
        """Lines 352-354: bad category → ValueError."""
        with pytest.raises(ValueError, match="Unsupported category"):
            svc.add_unit("fake_category", "unit", "m", 1.0)

    def test_add_unit_unknown_reference_raises(self, svc) -> Any:
    ...
    def test_add_unit_already_exists_raises(self, svc) -> Any:
        """Lines 361-363: unit already in category → ValueError."""
        with pytest.raises(ValueError, match="already exists"):
            svc.add_unit("length", "m", "m", 1.0)

    def test_add_unit_non_positive_factor_raises(self, svc) -> Any:
    ...
    def test_add_unit_triggers_warning_on_convert(self, svc) -> Any:
...
class TestConvertGasFlowScfmAcfm:
    ...
    def test_acfm_to_scfm_with_compressibility(self, svc) -> Any:
    ...
    def test_acfm_to_scfm_zero_compressibility(self, svc) -> Any:
    ...
    def test_acfm_ensure_inputs_raises_when_no_tp(self, svc) -> Any:
...
class TestHeatingValue:
    ...
    def test_unknown_from_unit_raises(self, svc) -> Any:
    ...
    def test_btu_scf_to_mj_kg_requires_density(self, svc) -> Any:
    ...
    def test_kwh_nm3_conversion(self, svc) -> Any:
...
class TestTarConcentration:
    ...
    def test_to_mg_m3(self, svc) -> Any:
...
class TestGasifierPerformance:
    ...
    def test_specific_production_unknown_raises(self, svc) -> Any:
    ...
    def test_unknown_metric_type_raises(self, svc) -> Any:
...
class TestCompressibilityFactor:
    def test_air_at_standard_conditions(self, svc) -> Any:
    ...
    def test_extreme_conditions_returns_one(self, svc) -> Any:
...
class TestGetSupportedUnits:
    def test_all_categories_returned_without_filter(self, svc) -> Any:
...
class TestValidateValue:
    def test_temperature_below_absolute_zero_warns(self, svc) -> Any:
    ...
    def test_negative_pressure_warns(self, svc) -> Any:
    ...
    def test_positive_pressure_no_warning(self, svc) -> Any:
...
class TestGasFlowDispatch:
    def test_get_category_scfm_is_gas_flow(self, svc) -> Any:
        """Line 300: SCFM → 'gas_flow' category."""
        cat = svc._get_category("SCFM")
        assert cat == "gas_flow"

    def test_get_category_acfm_is_gas_flow(self, svc) -> Any:
        cat = svc._get_category("ACFM")
        assert cat == "gas_flow"

    def test_get_category_nm3_hr_is_gas_flow(self, svc) -> Any:
        cat = svc._get_category("Nm3/hr")
        assert cat == "gas_flow"

    def test_get_category_unknown_is_none(self, svc) -> Any:
    ...
    def test_gas_flow_scfm_to_nm3_hr(self, svc) -> Any:
    ...
    def test_gas_flow_mass_unit_to_scfm(self, svc) -> Any:
    ...
    def test_gas_flow_scfm_to_mass_unit(self, svc) -> Any:
    ...
    def test_gas_flow_unknown_from_unit_raises(self, svc) -> Any:
    ...
    def test_gas_flow_unknown_to_unit_raises(self, svc) -> Any:
...
class TestHeatingValueImplementedPaths:
    def test_btu_scf_to_btu_lb_raises_not_implemented(self, svc) -> Any:
    ...
    def test_kwh_nm3_to_btu_scf(self, svc) -> Any:
...
class TestTarConcentrationPaths:
    def test_from_unimplemented_unit_raises_via_factor_none(self, svc) -> Any:
    ...
    def test_tar_nm3_to_g_nm3_roundtrip(self, svc) -> Any:
