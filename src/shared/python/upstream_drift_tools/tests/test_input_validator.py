...
class TestRequirePositive:
    def test_positive_value_passes(self) -> Any:
...
class TestValidateComposition:
    ...
    def test_custom_tolerance_loose(self) -> Any:
