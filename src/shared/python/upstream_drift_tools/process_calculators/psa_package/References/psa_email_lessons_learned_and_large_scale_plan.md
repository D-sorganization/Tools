...
- Feed flow conversion to SCFM at 0 C, 1 atm: AveFeedSCFM = AveFeedFlow * SyngasMW * R * Ps * Ts (R=1.31443 ft^3*atm/lbmol/K, Ps=1 atm, Ts=273.15 K).
- Minimum rotational speed constraints (by flow and by component):
  - MinRPH,Flow = AveFeedSCFM * NominalRPH / NominalFlow.
  - MinRPH,CO = AveFeedSCFM * CO%/100 * NominalRPH / NominalCO.
  - MinRPH,CO2 = AveFeedSCFM * CO2%/100 * NominalRPH / NominalCO2.
