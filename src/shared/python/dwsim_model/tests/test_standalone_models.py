...
def test_gasifier_standalone(mock_build_stage, mock_builder_class, mock_get_automation) -> None:
...
def test_pem_standalone(mock_build_stage, mock_builder_class, mock_get_automation) -> None:
...
def test_trc_standalone(mock_build_stage, mock_builder_class, mock_get_automation) -> None:
