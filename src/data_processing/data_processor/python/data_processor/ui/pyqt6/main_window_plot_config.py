...
class PlotConfigMixin:
    ...
    def _save_plot_config(self) -> None:
        ...
        if not name:
            QMessageBox.warning(self, "No Name", "Please enter a configuration name.")  # type: ignore[arg-type]  # noqa: E501
            return
        ...
        try:
            ...
            config = {
                ...
                "trendline_type": self.trendline_type_combo.currentText(),  # type: ignore[attr-defined]  # noqa: E501
                "poly_degree": self.poly_degree_spin.value(),  # type: ignore[attr-defined]  # noqa: E501
                "trend_x_min": self.trend_x_min_edit.text(),  # type: ignore[attr-defined]  # noqa: E501
                "trend_x_max": self.trend_x_max_edit.text(),  # type: ignore[attr-defined]  # noqa: E501
            }

            self.plot_config_manager.save_plot_config(name, config)  # type: ignore[attr-defined]  # noqa: E501
            self._refresh_saved_plots_list()

            self.status_bar.set_status(f"Saved plot config: {name}")  # type: ignore[attr-defined]  # noqa: E501
    ...
    def _load_plot_config(self) -> None:
        ...
        try:
            name = item.text()
            config = self.plot_config_manager.load_plot_config(name)  # type: ignore[attr-defined]  # noqa: E501

            if config:
                self.plot_name_edit.setText(config.get("name", ""))  # type: ignore[attr-defined]  # noqa: E501
                ...
                idx = self.trendline_type_combo.findText(trend_type)  # type: ignore[attr-defined]  # noqa: E501
                if idx >= 0:
                    self.trendline_type_combo.setCurrentIndex(idx)  # type: ignore[attr-defined]  # noqa: E501

                self.poly_degree_spin.setValue(config.get("poly_degree", 2))  # type: ignore[attr-defined]  # noqa: E501

                self.trend_x_min_edit.setText(config.get("trend_x_min", ""))  # type: ignore[attr-defined]  # noqa: E501
                self.trend_x_max_edit.setText(config.get("trend_x_max", ""))  # type: ignore[attr-defined]  # noqa: E501

                y_signals = config.get("y_signals", [])
                self.signal_list.select_signals(y_signals)  # type: ignore[attr-defined]

                self.status_bar.set_status(f"Loaded plot config: {name}")  # type: ignore[attr-defined]  # noqa: E501
    ...
    def _delete_plot_config(self) -> None:
        ...
        if reply == QMessageBox.StandardButton.Yes:
            try:
                self.plot_config_manager.delete_plot_config(name)  # type: ignore[attr-defined]  # noqa: E501
                self._refresh_saved_plots_list()
                self.status_bar.set_status(f"Deleted plot config: {name}")  # type: ignore[attr-defined]  # noqa: E501
            except (RuntimeError, AttributeError) as e:
    ...
    def _refresh_saved_plots_list(self) -> None:
        ...
        try:
            configs = self.plot_config_manager.list_plot_configs()  # type: ignore[attr-defined]  # noqa: E501
            for name in configs:
