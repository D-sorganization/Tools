        ...
        {helpSections.map((section) => {
          ...
          return (
            <div key={section.title} className="border border-dark-700 rounded-lg">
              <button
                className="w-full p-3 flex items-center justify-between text-left hover:bg-dark-700/50"
              ...
              {isExpanded && (
                <div className="px-3 pb-3 text-sm text-dark-300 whitespace-pre-line">
