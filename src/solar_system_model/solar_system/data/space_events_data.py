"""
Historical Space Events — Data Module
======================================

Pure-data module containing the ``SPACE_EVENTS`` database used by
:mod:`solar_system.data.historical_events`.

The data was extracted from ``historical_events.py`` (issue #2152) to
keep the query API module focused on behaviour and to keep each file
under the 1000-line budget. All callers should continue to import from
``solar_system.data.historical_events``; this module is an implementation
detail.
"""
