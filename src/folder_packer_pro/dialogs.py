...
class DialogsMixin:
    ...
    def _manage_exclusions(self) -> None:
        ...
        for pattern in sorted(self.exclude_patterns):  # type: ignore[has-type]
        ...
        def add_pattern() -> None:
            ...
            if pattern:
                self.exclude_patterns.add(pattern)  # type: ignore[has-type]
                listbox.insert("end", pattern)
        ...
        def remove_pattern() -> None:
            ...
            if selection:
                ...
                self.exclude_patterns.discard(pattern)  # type: ignore[has-type]
