...
class ControlsWidgetGolfer(ControlsWidgetBase):
    ...
    def _build_mass_section(self) -> QGroupBox:
        ...
        if _HAS_UAI:
            ...
            self.inp_m_hub = LabeledInput("Standoff", "0.001", "Standoff mass (massless)")    # type: ignore
    ...
    def _build_length_section(self) -> QGroupBox:
        ...
        if _HAS_UAI:
            ...
            self.inp_L_hub = LabeledInput("Standoff", "0.15", "Standoff length (COM offset)")    # type: ignore
