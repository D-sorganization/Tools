...
class TestDiagnosticsTracker:
    ...
    def test_error_count(self, temp_tracker):
    ...
    def test_record_exception(self, temp_tracker):
        try:
            1 / 0
    ...
    def test_clear_events(self, temp_tracker):
...
class TestDiagnosticsViewer:
    def test_viewer_init_and_populate(self, temp_tracker, qtbot):
    ...
    def test_filter_combobox_changes(self, temp_tracker, qtbot):
    ...
    def test_row_selection_shows_details(self, temp_tracker, qtbot):
    ...
    def test_clear_button(self, temp_tracker, qtbot):
    ...
    def test_copy_details(self, temp_tracker, qtbot):
...
class TestExceptionHook:
    def test_hook_records_event(self, temp_tracker):
