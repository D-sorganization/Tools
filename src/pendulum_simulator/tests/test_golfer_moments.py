...
class TestGolferPendulumMoments:
    ...
    def test_returns_all_21_keys(self, sample_positions, sample_forces) -> Any:
    ...
    def test_applied_torques_preserved(self, sample_positions, sample_forces) -> Any:
    ...
    def test_all_values_finite(self, sample_positions, sample_forces) -> Any:
    ...
    def test_total_equals_applied_plus_moment(self, sample_positions, sample_forces) -> Any:
    ...
    def test_zero_torques_yield_nonzero_moments(self, sample_positions, sample_forces) -> Any:
    ...
    def test_missing_position_key_graceful(self, sample_forces) -> Any:
