...
class TestGenerateNoise:
    ...
    def test_different_seeds_differ(self) -> Any:
...
class TestPerturbTorqueCoeffs:
    ...
    def test_preserves_shape(self) -> Any:
    ...
    def test_zero_amplitude_no_change(self) -> Any:
    ...
    def test_perturbation_changes_values(self) -> Any:
        coeffs = [[1.0, 2.0, 3.0]]
        perturbed = perturb_torque_coeffs(
...
class TestPerturbationConfig:
    ...
    def test_invalid_n_trials(self) -> Any:
...
class TestVariabilitySummary:
    ...
    def test_summary_keys(self) -> Any:
    ...
    def test_zero_variance(self) -> Any:
    ...
    def test_cv_computation(self) -> Any:
...
class TestBatchPerturbAndSimulate:
    ...
    def test_runs_n_trials(self) -> Any:
        ...
        def simulate_fn(coeffs) -> Any:
            return {"coeffs": coeffs}

        def extract_fn(result) -> Any:
            return {
    ...
    def test_handles_failures_gracefully(self) -> Any:
...
class TestPerturbedSimulationFiniteOutputs:
    ...
    def test_finite_outputs_across_trials(self) -> Any:
    ...
    def test_variability_summary_finite_with_perturbed_inputs(self) -> Any:
