...
from PyQt6.QtGui import QColor, QPaintEvent, QRegion, QPainter

from double_pendulum_golf.gui.torque_history_widget import TorqueHistoryWidget, _HAS_PYQTGRAPH
...
def mock_pyqtgraph(monkeypatch):
    ...
    class DummyPlotWidget(QWidget):
        ...
        def plot(self, *args, **kwargs): return MagicMock()
