...
| `putting_launch_monitor`   | Biomechanics         | PyQt6       | beta         | Measure putt launch speed and direction from an overhead camera and send them to GSPro                                                                                                                                                                                                            | [docs](src/putting_launch_monitor/README.md)           |
