...
> > > > > > > origin/codex/repair-data-explorer-dtype
...
- Shared calculator backend APIs expose bounded symbolic expression
  simplification, expansion, factoring, differentiation, integration, and
  equation solving through typed request/response contracts and the Sidekick
  calculator tab
...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-15 | 1.1.177 | Added a bounded symbolic calculator backend contract with FastAPI routing, symbolic operation helpers, Sidekick calculator assistance wiring, and focused backend/sidebar regression coverage.                                                                                                                                                                                                                                                                                                                                                                      |
| 2026-05-14 | 1.1.176 | Stabilized Sidekick data explorer dtype summaries across pandas string dtype changes and kept calculator-tab expression evaluation inside the shared safe math evaluator so headless imports do not require Flask or tool-specific calculator packages.                                                                                                                                                                                                                                                                                                             |
