...
pins all three exact import roots.
...
| ---- | ------- | ------- |
| 2026-08-26 | 1.18.34 | fix(ci, #4764): include UpstreamDrift's `src/bunkershot3d` and double-pendulum engine packages in the shallow downstream sparse checkout so shared simulation-backend wrench imports resolve and the provider/variation contracts test the current Tools authority. |
