...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-04-11 | 1.1.38  | Optimize applyFormula in useDataProcessor.ts by replacing chained array map methods with a single-pass loop and explicitly allocating temporary arguments arrays to prevent massive GC overhead during dynamic formula evaluation.                                                                                                                                                                                                                     |
