...
| Data Processing          | `src/data_processing/`                                                                 | Pipelines, transformers, validators, and facade-based data-processor core modules for exporter, ANOVA, vectorized filter workflows, checked normalize/standardize transforms, operator-whitelisted row filtering, and pickle-safe file I/O defaults |
...
| Rust Kernels             | `rust_core/`                                                                           | High-performance mathematical operations, including canonical physical constants and standard atmosphere calculations that require finite, non-negative altitudes                                                                                   |
...
| 2026-04-22 | 1.1.94  | Unified the Rust universal gas constant precision by updating `math::R_GAS` to the same CODATA value used by `engineering::R_UNIVERSAL`, with regression coverage to keep the constants aligned.                                                                                                                                                                                                                                                                                                                                                                    |
