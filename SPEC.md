...
- **Chore**: Fixed import order in `tests/conftest.py` to satisfy ruff I001 lint rule — moved `import pytest` before `from PyQt6.QtWidgets import QApplication` within the try block.
