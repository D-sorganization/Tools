...
| ---- | ------- | ------- |
| 2026-07-29 | 1.5.4 | feat(ui): Improved keyboard accessibility in the rotation converter web application by adding explicit focus-visible styles to all form inputs, selects, and buttons. |
