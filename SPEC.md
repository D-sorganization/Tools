...
| ---- | ------- | ------- |
| 2026-09-03 | 1.18.122 | perf(playback): replace Math.min/max spreads in flightPlaybackDrawing.ts with single-pass for loops to eliminate garbage collection pressure and prevent stack overflows on large datasets. | |
