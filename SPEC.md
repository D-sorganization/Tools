...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-05 | #4977 | fix(rate): preserve caller scroll position in variation lifecycle E2E, refresh vendored performance config, and calibrate PyQt visual baseline font tolerance across fleet runners (#4977). |
