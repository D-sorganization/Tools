...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-09 | #5144 | Resolve the Function Generator launcher to its canonical registered widget after the provider migration; retain GUI and engine regression controls. Fixes #5143. |
