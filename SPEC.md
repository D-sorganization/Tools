...
=======
| 2026-05-30 | 1.1.215 | Hardened Sidekick state loading so corrupt JSON state files return no state instead of raising a JSON decoding exception, preserving graceful state-manager recovery behavior. |

> > > > > > > origin/fix/sidekick-corrupt-json-state
