...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-08 | #5097 | Extract private Rust watcher quiet-period batching with exact logical-time tests, preserve filesystem event semantics, and replace the scheduling-dependent debounce assertion. |
