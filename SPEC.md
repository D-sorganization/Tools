...
| ---- | ------- | ------- |
| 2026-08-22 | 1.17.89 | docs(rate-of-closure, #4142/#4433): reconcile both bounded handoffs after protected PR #4646 merged. The records now pin its merge commit as an ancestor of current remote `main`, preserve the distinction between completed R11.5 visual qualification and still-open requirement-level epic closure, and identify the immutable UpstreamDrift consumer pin/parity slice as remaining work. No runtime, baseline, or scientific authority changes. |
