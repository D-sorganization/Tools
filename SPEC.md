...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-09 | #5114 | Deliver deferred native Qt deletion between Rate tests after fixture finalizers while retaining exception capture; regression checks widget/child ownership without GC timing and no application creation for non-GUI cases. Preserve test deadlines and all physical calculations. |
