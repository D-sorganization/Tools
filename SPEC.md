...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-09 | #5143 | Resolve the Function Generator launcher to its canonical registered widget after the provider migration; retain GUI and engine regression controls. Governing issue used before the follow-up PR exists. |
