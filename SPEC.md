...
### 2026-08-26 Deterministic Club-View Render Work Budget (#4756)
...
| ---- | ------- | ------- |
| 2026-08-26 | 1.18.27 | test(rate-of-closure, #4756): measure the worst-library-mesh draw's bounded CPU work with a monotonic process clock so parallel hosted-runner scheduling cannot masquerade as a rendering regression. Preserve the 200 ms playback cadence and 0.5 s work ceiling. |
