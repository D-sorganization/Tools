...
| **Current Version**     | N/A                                        |
| **Spec Version**        | 1.1.77                                     |
| **Last Spec Update**    | 2026-04-19 (updated for PR #2146)          |
...
| 2026-04-19 | 1.1.66  | Hardened model import and data-loading surfaces by validating archive member paths before extraction, rejecting unsafe URDF mesh path resolution, gating unit-converter debug mode behind `UNIT_CONVERTER_DEBUG`, requiring explicit pickle-load opt-in while keeping pickle writes disabled, and restoring the unit converter template so focused webapp tests run.                                                                                                                                      |
