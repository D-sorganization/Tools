...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-16 | #5231 | ⚡ Bolt: Use single-pass loops for calculating scale from eigenvalues in `variationDispersionMath` in rate_of_closure to eliminate intermediate array allocations in performance-critical numerical kernels. | #5231 (spec 1.18.74) |
...
| 2026-09-10 | #5152 | Review adaptive normal-contact events and five-channel work with 386 Windows/Linux controls; verify the independent oracle with SI root-residual checks and a deliberately perturbed-root RED, independent piecewise-linear event/work refinement, shared Lie/body/contact kernels and strict domain/budget refusal. Preserve all existing API records. Repair isolated scalar and CI ndarray return typing with explicit local types; all15 affected event controls and isolated mypy pass. Physical/acoustic qualification and remaining T4 coupling stay open. |
| 2026-09-10 | #5149 | Preserve mocap CLI/service main 9899c5a6a with 12 CLI/service and one API control passing; retain the qualified impact source unchanged. Review the private normal-contact trajectory and shared local-chart RK4 with 371 Windows/Linux controls, disjoint work/loss accounting and unchanged pre-existing API records. Contact events, friction, face modes and physical/acoustic qualification remain under #5073. |
...
| 2026-09-09 | #5073 | Add private normal shaft/ball trajectories with prescribed grips and disjoint work, 12 temporal/domain controls and unchanged existing API records. Extract shared local-chart RK4 with unchanged shaft contracts and 36 independent kernel/geometry/disturbance controls; retain contact/event qualification as open. Add private common-point geometry, disjoint normal and objective tangential work ports, full-tensor free-body response and instantaneous shaft/ball normal coupling with moving-grip energy accounting. Share the canonical inertia and scaled mass solve; preserve existing API records and legacy T2 equations. Verify axial three-mass, nonplanar work, observer invariance and strict domains. Full trajectories, face modes, convergence and physical/acoustic qualification remain. |
| 2026-09-10 | #5169 | Estimate global metric scale from identified ruler endpoints and established camera geometry; preserve source evidence, rotations and lens profiles. Validate independent held-out lengths, raw reprojection, parallax, zoom identity and anchored projection invariance. Physical accuracy and engineering-manual publication remain unapproved. Preserve main 28de742e2 chart-bound fixes, regenerate the combined provider inventory, and register only the three additive Sidekick API modules with every existing entry unchanged. |
...
| 2026-09-09 | #5141 | Dependency-free source context package, real MCP transport, semantic boundary reviews, deterministic views and CodeMap freshness guards.; explicit-checkout hook isolation and responsive offline navigation and isolated real-SDK transport qualification. Explicit unsupported state and concurrent dependency-change rejection. CodeMap documentation reflects actual worktree freshness and graph limits; Qt translation XML is classified separately from TypeScript with malformed-input and freshness regressions; qualify fastmcp import availability in real mcp transport test. Require real SDK imports in the context qualification lane while preserving optional broad-suite discovery. Preserve the reviewed launcher#5143/#5144 correction in the combined provider used for final consumer pins. Integrate the protected #5158 serial Club Tester repair without changing test selection, coverage or deadlines. |
| 2026-09-10 | #5158 | Isolate the complete Club Tester scientific GUI test file serially within the rate shard; retain every test, existing deadline, separate coverage outputs and failure propagation. |
...
| 2026-09-08 | #5072 | Couple finite grips to all-node loaded shaft balance, response and separate-G/C spectra; retain constant-affine residual bounds and explicit operating prescriptions. Add finite-time affine motion through a shared validated augmented exponential with owned scaled states, preserving neutral/defective/growing cases. Verify analytic oscillators/energy, coupled physical-coordinate IVP agreement, strict domains and time-underflow refusal. Add work-conjugate real Galerkin reduction with full/projected plant checks, full-basis transient/FRF equivalence and sampled finite-grip modal convergence; no omitted-mode or bandwidth certificate. Verify stationary bending/shear/rotary continuum response and separate mesh/modal truncation errors at bounded synthetic frequencies. Add conditional Neumann interval bounds retaining center-inverse defect and assumed coefficient error; refuse unresolved intervals and retain port magnitude/phase limits without certified-arithmetic or stability claims. Integrate merged scientific-import classifier #5103 and regenerate the provisional inventory without changing shaft source/tests or approval status. Add bounded adaptive complete-band coverage reusing the interval assessor; exact binary endpoint enclosure, strict budgets and no partial results. Verify analytic resonance, coupled nonreciprocal response and existing shaft ports; preserve unqualified stability and conditional numerical status. Compose current finite-pose shaft inertia with prescribed moving-grip inertance, force and both work ports in an explicit inertial observer; verify nonlinear acceleration, independent momentum/energy rates, frame/scaling invariance and rotating-balance equivalence. Share strict node, mass and robust norm helpers; tiny-force corrupted-solve RED prevents squared-norm false acceptance. Add budgeted proper-pose Lie midpoint trajectories with both work ports and independent axial/quaternion time references; retain explicit unqualified status and stage-domain refusal. Share work-only force assembly with full curvature without duplicated physics. Qualify axial time/mesh convergence against independent continuum and scalar FEM exponentials, plus finite-root rotating continuum and exact corotation histories; retain both-platform numerical evidence without changing production/API. Add explicitly normalized full/reduced displacement-transfer bounds with projected uncertainty, computed-inverse defects and residual-corrected response polynomials; share complete-band coverage with strict paired budgets and no partial acceptance. Qualify analytic omitted modes, antiresonance, nonorthogonal and nonreciprocal cases plus an assembled low-frequency shaft band; retain undamped unobservable-pole refusal. Preserve an explicit float return for changed-file typing with skipped imports. Add conditional SISO response floors and relative magnitude/principal phase bounds with strict all-target complete-band acceptance. Verify antiresonance, phase wrapping, tiny/huge geometry, uncertainty and independent nonreciprocal adjugate references. Retain absolute-error failures of pure modal bending/torsion bases; qualify explicit tip/grip static enrichment against unchanged band/targets. Add local Lie RK4 with exact right-Jacobian correction, explicit 4N+1 budgets and shared midpoint/result/work infrastructure; refuse method-control mismatches. Retain midpoint accuracy counterexamples and verify fourth-order noncommuting motion, unchanged rotating-disturbance accuracy, quadratic nonlinear/tangent amplitude consistency and nested-mesh release convergence. Distinguish shared-force time references and fine-mesh comparisons from independent constitutive/continuum or physical evidence. Complete transient/modal/mesh/FRF bandwidth, moving/nonlinear and physical/acoustic qualification before T3 closure. Add versioned explicit distributed coefficient/source inputs, strict numeric wire contracts and exact source byte identity; compile through existing mechanics without inference or duplicated quadrature weights. Preserve unqualified physical status. Existing public API records are unchanged; shaft_model_data is an additive public module. |
...
| 2026-09-08 | #5090 | fix(ci): bind both PyQt capture paths to one immutable Ubuntu container and exact font stack, check Qt runtime/SIP pins, retain protected image review and all drift tolerances, type the inherited force-perturbation test result explicitly, and initialize scoped checkout trust/candidate paths inside the mounted container, use one private owned home for browser installation and execution; qualify repeated Linux capture and propose reviewed references with exact source/digests and unchanged tolerances. |
| 2026-09-08 | #5097 | Extract private Rust watcher quiet-period batching with exact logical-time tests, preserve filesystem event semantics, and replace the scheduling-dependent debounce assertion. Preserve incoming API JSON values under required formatting and type the adversarial ingestion fixture without an invalid suppression. |
| 2026-09-08 | #5083 | feat(swing_sim, #5068 IA-T6/#5075): add versioned impact study wire (`swing_sim.impact_study/1`) with model evidence tiers, provenance/calibration IDs, separated launch/contact/vibration/acoustic sections, completeness and invalid-case records, deterministic serialization, and a truthful application surface that refuses unavailable acoustics in `shared.python.swing_sim.impact_studies`. |
| 2026-09-08 | #5084 | feat(swing_sim, #5068 IA-T5/#5074): add vibroacoustic measurement ingestion in `shared.python.swing_sim.vibroacoustics` — calibrated waveform recordings with measured/synthesized source kinds, raw-data hashes, clipping and Nyquist-bandwidth checks, cross-correlation time alignment, Welch PSD with Parseval-consistent normalization, modal decay estimation, and H1 FRF estimation. |
...
| 2026-09-08 | #5078 | fix(theme, #5063): restore the `ThemeColors` 60-token semantic derivation pipeline (`model_post_init`, `is_dark` inference, the derived surface/border/text/brand/semantic/chart/effect tokens, dict-style access, `as_dict`), the `_derive_full_palette` package shim, and the `color_derivation` colour-math helper module stripped from the canonical tree by the UpstreamDrift `b8d95ad25` sync wave; mirror the 8-case derivation regression oracle into `tests/shared/python/theme/test_theme_colors_derivation.py` (RED 7 failed/1 passed before, 8 passed after). Deliberately not restored (zero references per the issue): `ThemeColorsCompat` and `style_for_export`. Follow-up: bump UpstreamDrift's `vendor/ud-tools` pin after merge. |
| 2026-09-08 | #5070 | chore(release): bump the workspace version to v1.17.0 across `VERSION`, `pyproject.toml`, `package.json`, and the release `CHANGELOG.md`; no governed source, schema, or test paths change. |
...
| 2026-09-14 | n/a | Replaced Math.max with single-pass loops in matrix cell rendering (spec 1.18.74) |
