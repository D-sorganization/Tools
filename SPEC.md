...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-08 | #5101 | Detect real Python scientific imports through non-executing AST inspection, refuse unparseable source, preserve non-Python/path rules, and regenerate the fully reviewed inventory delta without promoting scientific or publication approval. |
