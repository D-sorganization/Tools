...
| 2026-09-08 | #5072 | Add finite-pose grip kinematics and a separate coordinate impedance sharing existing energy algebra; verify physical reaction gradients, storage/loss and moving-observer power. Retain private loaded tip force/torque compliance, continuum/support controls and coefficient-cancellation refusal. Loaded grip balance/tangent, time evolution, stability and full bandwidth/impact/acoustic qualification remain open. |
