...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-08 | #5090 | fix(ci): bind both PyQt capture paths to one immutable Ubuntu container and exact font stack, check Qt runtime/SIP pins, and retain protected image review and all drift tolerances. |
