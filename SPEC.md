...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-20 | n/a | ⚡ Bolt: Replace array spread with native slice() for sorting large arrays in chipForgiveness.ts and windStrategyMetrics.ts to reduce GC pressure (spec 1.18.143). |
