...
| ---- | ------- | ------- |
| 2026-06-19 | 1.1.605 | fix(shared, #3671): make AI shell command validation fail closed and log the offending token when path normalization raises, preventing dangerous-executable checks from being silently skipped. |
