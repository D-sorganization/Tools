...
| 2026-09-08 | #5072 | Add private six-axis tip force/torque compliance at explicit material offsets, reusing loaded operators and shared clamped-balance checks. Verify continuum compliance, support reactions, point-port power and coefficient-cancellation refusal without added damping. Stability, moving work, loaded grip and full bandwidth/impact/acoustic qualification remain open. |
