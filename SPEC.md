...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5114 | Isolate the complete Club Tester scientific GUI test file serially within the rate shard; retain every test, existing deadline, separate coverage outputs and failure propagation. |
