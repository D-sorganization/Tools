...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5162 | Couple objective friction history to shaft-ball mechanics and disjoint work; independent sticking, sliding, entry and release references. Bounded SE(3) Jacobian evaluation retains general fallback and exact zero-direction behavior;1517 coverage tests pass with2 optional CAD skips,93.53% coverage and unchanged60s deadline, followed by63 post-import controls. Event-work, hosted, physical and acoustic qualification remain open; contact-force regularity requirements are documented. |
...
| 2026-09-10 | #5152 | Review adaptive normal-contact events and five-channel work with 386 Windows/Linux controls, independent piecewise-linear event/work refinement, shared Lie/body/contact kernels and strict domain/budget refusal. Preserve all existing API records. Repair three isolated publication type errors with explicit return types; all15 affected event controls and isolated mypy pass. Physical/acoustic qualification and remaining T4 coupling stay open. |
