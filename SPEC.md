...
| 2026-09-08 | #5072 | Couple finite grips to all-node loaded shaft balance, M/G/C/K and point frequency response. Share clamped numerical checks; verify dynamic-boundary rod/continuum convergence, separate support reactions, offset power and rotating preload balance. Stability, bandwidth, time evolution and physical/acoustic qualification remain open. |
