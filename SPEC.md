...
| 2026-04-09 | 1.1.33  | Refactor `integrateSignals` in `useDataProcessor.ts` to replace `Array.prototype.map()` with a single-pass `for` loop and a `Float64Array` accumulator to dramatically improve execution speed and fix logic errors.                                                                                                                                                                                                                                |
