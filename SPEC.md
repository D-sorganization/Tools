...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-20 | #4253 | feat(variation): Sobol indices via Saltelli sampling, Spearman significance & bootstrap CIs, landing ellipse bivariate normality & convex hull fallback, and truncation mean-shift analysis (#4253) |
