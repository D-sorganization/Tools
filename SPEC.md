...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5160 | Couple objective elastic/Coulomb history to shaft-ball endpoint mechanics with declared transport and disjoint work. Independent motion/force/work/momentum and release controls pass; componentwise positive-gap spin refinement and physical/acoustic qualification remain open. |
