...
| 2026-04-22 | 1.1.83  | Documentation (closes #2198): reviewed duplicate responsibility clusters for `api`, `app`, `build`, `cli`, and `config`, documenting that the repeated filenames are package/framework boundaries across independent tools rather than shared implementations that should be merged.                                                                                                                                                                                                                         |
