...
| 2026-04-22 | 1.1.91  | Hardened CI dependency bootstrap workflows to install `wheel` with `--ignore-installed --no-deps`, avoiding uninstall attempts against self-hosted runner environments with corrupt wheel metadata.                                                                                                                                                                                                                                                                                                      |
