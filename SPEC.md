...
| 2026-09-08 | #5072 | Add tensile FEM, passive six-axis grip, stationary spatial shaft/full head and rotating transport with explicit section inertia; 110 combined tests verify energy derivatives, frame trajectory and published radial modes. Private objective section interpolation adds 26 circular-bending, tiny-angle and branch-contract tests. Loaded-state/work/FRF and full T3 qualification remain open. Add explicit coupled section energy and its complete analytic fixed-chart geometric tangent; Add offset spatial force/couple work and full canonical load tangents with explicit validated float boundaries; Assemble full-node chain residuals/tangents with repeated point loads, complete curvature and support-reaction checks; Add clamped-chain root finding with explicit strain limits, moving-material Jacobian, support reactions and nonconvergence refusal; Add consistent SE(3) kinetic quadrature with independent COM/spin, inertial-wrench and energy-rate oracles; Add deformed-section rotating inertia, full moving-material derivatives and gyroscopic terms with independent Newton/Euler, energy-curvature and observer-change checks; Add rotating loaded-chain composition with shared chart conversion and existing strain-bounded Newton solve; centrifugal extension and origin-acceleration support agree with independent continuum solutions. 560 golf/API tests pass with two optional CAD skips. Stability, work, grip and FRF qualification remain open. |
