...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-16 | 1.1.61  | Hardened PDF Renamer API-key handling by using OS keyring storage with environment-variable fallback only, preserving `.env` ignore coverage without writing plaintext secrets, and constrained shared CORS defaults to explicit methods and headers. |
