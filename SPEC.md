...
| 2026-04-22 | 1.1.94  | Exposed the `DataProcessor.apply_filter()` Butterworth sample rate as a validated API parameter so non-1 kHz datasets can be filtered with their actual acquisition rate instead of relying on an implicit fixed sampling frequency.                                                                                                                                                                                                                                                                                                                                |
