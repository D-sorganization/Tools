...
| 2026-07-31 | 1.5.4 | Added loading state (isLoading) with disabled and aria-busy attributes to calculation buttons in RotationConverter and ReferenceFrameConverter. |
