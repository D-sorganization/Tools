...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5162 | Couple objective friction history to shaft-ball mechanics and disjoint work; independent sticking, sliding, entry and release references. Exact section-kinematics reuse preserves numerical contracts:1481 tests pass with2 optional CAD skips,93.51% coverage and unchanged60s deadline. Event-work, hosted, physical and acoustic qualification remain open; contact-force regularity requirements are documented. |
