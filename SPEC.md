...
| ---- | ------- | ------- |
| 2026-08-12 | 1.16.32 | chore(rate-of-closure, #4400): apply Ruff's canonical formatting to the PyQt Morris workflow test after the first protected quality gate isolated that single failure, and extract immutable UI labels and bounds to internal `variation_constants.py` to restore the 500-line changed-file budget. No material runtime, API, authority, or scientific behavior changes; all R13.7 validation remains required on the new exact head. |
