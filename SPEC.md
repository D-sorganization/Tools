...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5152 | Review adaptive normal-contact events and five-channel work with 386 Windows/Linux controls, independent piecewise-linear event/work refinement, shared Lie/body/contact kernels and strict domain/budget refusal. Preserve all existing API records. Repair isolated scalar and CI ndarray return typing with explicit local types; all15 affected event controls and isolated mypy pass. Physical/acoustic qualification and remaining T4 coupling stay open. |
