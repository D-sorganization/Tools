...
| 2026-09-07 | #5072 | Add prescribed tensile shaft FEM and radial prestress with shared beam kernel, plus a passive six-axis local grip impedance with energy/power accounting and fixed-frame congruence; independent beam and port benchmarks pass, while full coupled T3 remains open. |
