...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-09 | #5132 | Repair calibration inverse distortion, explicit PnP failure and actual fixed-world-target camera pose refinement; preserve provisional physical/publication status. |
