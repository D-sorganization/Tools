...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5149 | Review the private normal-contact trajectory and shared local-chart RK4 with 371 Windows/Linux controls, disjoint work/loss accounting and unchanged pre-existing API records. Contact events, friction, face modes and physical/acoustic qualification remain under #5073. |
