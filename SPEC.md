...
| 2026-09-08 | #5072 | Couple finite grips to all-node loaded shaft balance, frequency response and separate-G/C spectra. Share numerical kernels, verify rod/continuum damped poles, offset power, support reactions and instability counterexamples. Explicit stability, bandwidth, nonlinear evolution and physical/acoustic qualification remain open. |
