...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-23 | 1.1.98  | Kept data-processing result timestamps timezone-aware while preserving Python 3.10 compatibility by using the standard `timezone.utc` constant instead of the Python 3.11-only `datetime.UTC` alias, allowing the shared data-processing exception import contract and CI test matrix to pass across supported interpreters.                                                                                                                                                                                                                                         |
