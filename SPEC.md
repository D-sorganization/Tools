...
| ---- | ------- | ------- |
| 2026-08-20 | 1.17.54 | 🎨 Palette: [accessibility] Add explicit IDs to form controls in LaunchMonitorAnalyticsPanel for screen reader support (`htmlFor` / `id` bindings across interpretation convention, outcome, predictors, analysis mode, correlation method, missing policy, grouping, confidence, and minimum samples controls). | #4537 |
