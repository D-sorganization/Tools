...
## IA-T3 Provider Launcher Follow-Up (#5143)

The merged shaft provider includes the #5110 Function Generator widget move.
Point the shared launcher manifest at its existing canonical registration;
preserve a source-resolution regression and all GUI/engine controls. No
mechanics, API signatures or physical qualification change. Coordinate the
exact downstream pin through UpstreamDrift #9912/#9916.
...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-09 | #5144 | Preserve camera/CLI and fleet main92283cf3f with the canonical launcher correction; retain the repeated GUI CI failure and combined-provider sequencing. Resolve the Function Generator launcher to its canonical registered widget after the provider migration; retain GUI and engine regression controls. Fixes #5143. |
