...
| ---- | ------- | ------- |
| 2026-09-03 | 1.18.122 | fix(rate-web, RM #1507 main-green): close the second 6 px horizontal document overflow of the putting tab at 390x844 — the green-import row. Layout-only fix: min-w-0 on the input label, w-full min-w-0 on the file input, and shrink-0 on the reset button. |
