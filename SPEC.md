...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-07 | #5069 | Add full-tensor detached contact mobility and normal-impulse references with analytic TDD gates, qualified legacy-model scope, and the distributed-impact/acoustics research specification. |
