...
| 2026-08-20 | 1.17.77 | feat(swing-sim, #4430): add the source-pinned qualified rotating-base provider, exact 18-case UpstreamDrift fixture, independently owned constrained physics, registered full-resolution execution, immutable reviewer traces, adverse-row retention, and fail-closed scientific boundaries; verify exact scalar parity, source identity, closures, and semantic tamper rejection. | #4430 |
