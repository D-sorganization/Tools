...
| 2026-09-08 | #5072 | Couple finite grips to all-node loaded shaft balance, response and separate-G/C spectra; share plant validation with a qualified autonomous Lyapunov decay envelope. Verify independent rod poles, transient growth, error-margin refusal, offset power and instability counterexamples. Driven/nonlinear stability, bandwidth and physical/acoustic qualification remain open. Preserve main integration with explicit fixture/dictionary types and runtime Qt fallbacks. Add private constant-affine response envelopes and explicit gripped operating prescriptions retaining residual forcing, owned frame/geometry/source IDs and separate operator/input assumptions. Share work-conjugate scaling with spectra; analytic rod/step-response and representability controls pass, with public APIs unchanged. |
