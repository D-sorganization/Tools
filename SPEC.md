...
| 2026-04-07 | 1.1.24  | Replaced raw `print()` summary emission in `scripts/generate_tools_json.py` with an explicit stdout helper and added regression coverage for the CLI entrypoint's generated-file summary contract.                                                                                                                                                                                                                                                     |
