...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5157 | Add explicit affine waveform calibration, declared acquisition/clock/source identity and first-order or exact independent-block shared gain/offset uncertainty. Preserve legacy recording/hash semantics; exact identity must retain sub-1e-11 changes. TDD covariance, domain, immutable and provenance refusal controls precede implementation. No physical calibration authentication or acoustic prediction. |
