...
| ---- | ------- | ------- |
| 2026-08-09 | 1.14.13 | feat(rate-of-closure, #4264): normally merge exact current wind-workflow carrier `bb101cedd555d07d493aae998b46050c68660cdd` into the draft four-surface branch without changing its base; add strict `four-surface-capability/v1` schema, canonical inventory, exact Tools evidence pin, and deterministic coverage of all 15 campaign programs, 18 unique linked active release specifications, and six curated evidence-backed capabilities; require stable declaration metadata, exact completeness/count gates, and specific four-surface unsupported reasons without inferring consumer parity. |
