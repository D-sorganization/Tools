...
| 2026-06-12 | 1.1.224 | Wrapped `sqlite3.connect` calls in `src/data_processing/data_processor/python/data_processor/file_utils.py` with `contextlib.closing` to prevent connection resource exhaustion if exceptions occur. |
