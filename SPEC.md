...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5162 | Couple objective elastic/Coulomb history to shaft-ball mechanics with explicit transport, termination and disjoint work. Independent sticking, sliding, first-contact and full-release references verify velocity/spin/impulse/work behavior in bounded cases;282 tests pass. Analytic quadrature evidence corrects an invalid cutoff-monotonicity assumption; relative cutoff/event-work, physical and acoustic qualification remains open. |
