...
| Shared Chat              | `src/shared/python/chat/`                                                              | Shared chat contracts, dock widgets, terminal-agent runtime boundaries, and UI-agnostic default provider descriptors for Claude Code, Codex, Cline CLI, and Gemini CLI                                                                                                                                              |
