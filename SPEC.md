...
| 2026-08-02 | 1.1.50 | Replaced data-entry `<div>` wrappers with native `<form>` elements and converted calculate buttons to `type="submit"` in the Rotation Converter application to enable native Enter key submission. |
