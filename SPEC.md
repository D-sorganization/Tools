...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-17 | 1.1.61  | Extracted shared rotation/reference-frame primitives into `rotation_transforms`, updated `calc_backend` and the `rotation_converter` tool compatibility layer to use the shared module, and added `rotation_converter` to the shared-library boundary guard so shared code cannot import the leaf tool package. |
