...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5162 | Couple objective elastic/Coulomb history to shaft-ball endpoint mechanics with declared transport and disjoint work. Record near-roundoff application stopping separately from backend success, always with a fresh residual check. Captured-state regressions and continuous sticking references pass; finer spin evidence is case-specific and physical/acoustic qualification remains open. |
