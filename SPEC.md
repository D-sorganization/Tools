...
| ---- | ------- | ------- |
| 2026-06-19 | 1.1.605 | test(model-generation, #3669): add route-dispatched `inertia/from-mesh` success coverage for both explicit mass and density inputs so mesh volume, COM, and inertia responses are exercised past early validation guards. |
