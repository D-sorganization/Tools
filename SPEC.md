...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-08 | #5074 | Require real immutable waveform samples, signed linear alignment, shared segment-detrended spectral estimates and explicit refusal of degenerate windows, absent excitation and nonfinite results; retain public signatures and unqualified physical/calibration status. |
