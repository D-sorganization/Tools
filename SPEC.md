...
| 2026-09-07 | #5072 | Add tensile FEM, passive six-axis grip, stationary spatial shaft/full head and rotating transport with explicit section inertia; 110 combined tests verify energy derivatives, frame trajectory and published radial modes. Loaded-state/work/FRF and full T3 qualification remain open. |
