...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5162 | Couple objective elastic/Coulomb history to shaft-ball mechanics with explicit transport, termination and disjoint work. Independent sticking, sliding and full-release references pass componentwise velocity/spin/impulse/work refinement, cutoff storage accounting and free-ball controls. All274 affected tests pass; general transition, physical and acoustic qualification remains open. |
