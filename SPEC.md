...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-06 | #5026 | fix(tests, #4933): unquarantine model generation api adapters, fix Flask endpoint collisions, and streamline rest_api shim (#4933); paired with UpstreamDrift#9432. |
