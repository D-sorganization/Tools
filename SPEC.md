...
| **License**             | MIT                                        |
| **Current Version**     | 1.16.26                                    |
| **Spec Version**        | 1.16.26                                    |
...
| ---- | ------- | ------- |
| 2026-08-11 | 1.16.26 | merge(camera/flight-ground, #4284 #4288 #4298): retain PR #4298's `feat/4284-camera-snap-tracking` branch and declared `feat/4199-wind-workflow` base at exact `51033696634c624f7c92c3822d98a66875ff90a0`; normally merge exact published camera child `35d04ee4bb4d74045594d3ef0b274e2b09cc5a3b` first with unpublished native orthographic-axis polish `37fa7f86dcdd7bf4225da34286e39f16837caba6` to form intermediate `da9ffd820f1596c398d137c84a29bd77e96e5ec5`, then normally merge exact refreshed flight-ground composite `8137621d7c77d9fa6941f5cd51d3fd161ebf4300` second; exclude stale held candidate `0eb576315498d4576b553e1ccc631345d9f6b23e` from ancestry, resolve the sole production conflict to the validated split kinetics façade, preserve camera snaps/tracking/zoom-safe auto-fit/native preset-axis presentation and flight-ground transfer, retain the optional-camera-command and capability-serializer typing narrowings, and keep publication, protected exact-head CI, review, and release open. |
...
| 2026-08-11 | 1.16.25 | merge(flight-ground, #4283 #4285 #4288): normally merge exact published qualified flight-ground-transfer child `3e6e418f98856162420dcb3f5f13dedd48d40439` first with exact refreshed strict-ground parent `7a6f31b6cb36e05f903c591e207480d36f491c4d` second while preserving #4288's actual `feat/4269-flight-ground-transfer` branch, `feat/4268-ground-contract` base, complete Python/TypeScript/Rust/PyO3/WASM transfer production/tests/fixtures, signed terminal angular state, physical contact evidence, cross-runtime contracts, and explicit incomplete ground-physics/UI/release limitations; preserve historical merged PR #4283 identity separately from current live carriers, retain additive handoff/SPEC/manifest histories without rebase, rename, retarget, force-push, parent rewrite, or remote publication, and keep protected exact-head CI, review, approval, and release open. |
| 2026-08-11 | 1.14.26 | merge(flight-ground, #4285 #4288): normally merge exact published qualified flight-ground-transfer child `c39297d37a17d5d8d3520ed62c5563cdcc609cab` first with exact reconciled strict-ground parent `d36551cead67e2544cf185584bff4d070ee663b3` second while preserving #4288's actual `feat/4269-flight-ground-transfer` branch, `feat/4268-ground-contract` base, complete Python/TypeScript/Rust/PyO3/WASM transfer production/tests/fixtures/contact evidence, cross-runtime contracts, and explicit incomplete ground-physics/UI/release limitations; retain additive handoff/SPEC/manifest histories and historical/current carrier identities without rebase, rename, retarget, force-push, parent rewrite, or remote publication, and keep protected exact-head CI, review, approval, and release open. |
...
| 2026-08-11 | 1.16.24 | merge(rate-of-closure, #4283 #4285 #4288): normally merge exact published strict ground-contract child `d36551cead67e2544cf185584bff4d070ee663b3` first with exact refreshed live capability carrier `0179abbdd8c0166f125d87e4d6ab47aeca15df40` second while preserving PR #4285's `feat/4197-capability-observer` base, complete UI-neutral `flight-to-ground/v1` schemas/fixture/migrations/adapters/dependency, and explicit fail-closed unimplemented-physics boundary; preserve historical merged PR #4283 at reviewed head `9bbb98e16e435a0d4c74153b909f2ebfefbbce7a` and merge SHA `c1827bbdc50a6e11cc475db2636b4e47a4c15416` while tracking its live dependency ancestry separately; retain additive handoff/SPEC/manifest histories, refresh verified published carrier heads without claiming this future local merge, and keep publication, protected exact-head CI, independent review, approval, normal #4288 propagation, and release open. |
| 2026-08-11 | 1.14.25 | merge(rate-of-closure, #4283 #4285): normally merge exact published strict ground-contract child `584e4e53a7990053a346938c4e45538786887ec7` first with exact reconciled live capability-observer carrier `6d10afb184ff79b11be0bdeb6bc2722b3c7d8912` second while preserving PR #4285's `feat/4197-capability-observer` base, complete strict `flight-to-ground/v1` production/tests/schemas/fixtures/dependencies, and fail-closed unimplemented-physics boundary; distinguish historical merged PR #4283 identity from its live dependency branch, inherit current wind/capability/release ancestry without rebase, retarget, force-push, parent rewrite, or remote publication, preserve additive handoff/SPEC/manifest histories, and keep protected exact-head CI, review, approval, release, and normal downstream #4288 propagation open. |
...
| 2026-08-11 | 1.16.23 | merge(rate-of-closure, #4282 #4283 #4285): keep historical PR #4283 merged at recorded head `9bbb98e16e435a0d4c74153b909f2ebfefbbce7a` and merge SHA `c1827bbdc50a6e11cc475db2636b4e47a4c15416` while using preserved branch `feat/4197-capability-observer` as the live dependency carrier; normally merge exact carrier child `6d10afb184ff79b11be0bdeb6bc2722b3c7d8912` first with exact refreshed wind-workflow parent `51033696634c624f7c92c3822d98a66875ff90a0` second without reopening or retargeting a PR or rewriting history; retain complete capability-observer functionality and history while inheriting the refreshed #4279–#4282 chain and strict unreleased manifest authority; keep independent review, protected exact-head CI, approval, #4285 propagation, and release open. |
| 2026-08-11 | 1.14.24 | merge(rate-of-closure, #4282 #4283 #4285): use the already-merged PR #4283 head branch as the preserved dependency carrier for open draft PR #4285; normally merge exact published capability-observer carrier child `d0b827667e61f0583e1dad0b3cbbca6819624d3c` first with exact reconciled wind-workflow parent `8c6105d865abe130a68cfa35ffe6afb7eef850c8` second without reopening or retargeting a PR or rewriting history; retain the complete capability-observer functionality and history while inheriting current wind workflow, scalar-adapter ancestry, campaign authority, kinetics, solver, layout, and Qt typing repairs; preserve additive handoff, SPEC, and manifest histories, and keep publication, protected exact-head CI, independent review, unresolved-thread checks, #4285 propagation, and release open. |
...
| 2026-08-11 | 1.16.22 | merge(rate-of-closure, #4279 #4280 #4281 #4282): normally merge exact published responsive wind-workflow child `8c6105d865abe130a68cfa35ffe6afb7eef850c8` first with exact refreshed wind scalar-adapter parent `73b7f6b45063ec71fa300a39d2185d3f935187b7` second while preserving PR #4282's `feat/4199-wind-scalar-adapter` base and both histories; retain responsive PyQt6/React execution, progress/cancellation, controls, scatter, persistence/export, capability integration, and strict campaign release authority while inheriting refreshed scalar-adapter, variation-export, and workspace/toolstrip ancestry; record current published carrier heads without self-referencing the future local merge and keep protected exact-head CI, independent review, approval, downstream propagation, and release open. |
| 2026-08-11 | 1.14.23 | merge(rate-of-closure, #4281 #4282): normally merge exact published responsive wind-workflow child `3faf9e9493c9ba37168d9f65ab10cafeedc2a72f` first with exact reconciled wind scalar-adapter parent `e934ba563a79bf95ee892fea8593972c81299eeb` second while preserving PR #4282's `feat/4199-wind-scalar-adapter` base and both histories; retain responsive PyQt6/React wind execution, progress/cancellation, controls, scatter, persistence/export, consolidated capability workflow, and strict campaign release authority while inheriting the current scalar-adapter, variation/export, workspace, kinetics, solver, layout, and Qt typing repairs; preserve additive handoff, SPEC, and manifest history, and keep publication, protected exact-head CI, independent review, unresolved-thread checks, dependency order, and release open. |
...
| 2026-08-11 | 1.16.21 | merge(rate-of-closure, #4279 #4280 #4281): normally merge exact published wind scalar-adapter child `e934ba563a79bf95ee892fea8593972c81299eeb` first with exact newly published variation-export parent `7fb5d7f489db49742b7bc82ef009570ad2502456` second while preserving PR #4281's `feat/4144-variation-export-continuation` base and both histories; retain matching Python/TypeScript `scalar-ensemble/v1` provenance, availability, deterministic-scenario and wind-strategy adapter behavior while inheriting current variation export and workspace/toolstrip ancestry; preserve the explicit pre-manifest boundary and all additive handoff/SPEC history without rebase, retarget, force-push, parent rewrite, or remote publication; keep protected exact-head CI, independent review, approval, downstream propagation, and release open. |
| 2026-08-11 | 1.14.22 | merge(rate-of-closure, #4280 #4281): normally merge exact published wind scalar-adapter child `9321c1d2e091b8c7e5a4a83aa9ad726290e7fb5a` first with exact reconciled variation-export parent `9b45bd5beca38370c1d541f8c488ef0edad08517` second while preserving PR #4281's `feat/4144-variation-export-continuation` base and both histories; retain matching Python/TypeScript `scalar-ensemble/v1` provenance, availability, deterministic-scenario, wind-strategy adapter, and strict module-budget behavior while inheriting current variation export, workspace/toolstrip, kinetics, solver, layout, and Qt typing repairs; preserve both append-only handoffs and SPEC histories, and keep publication, protected exact-head CI, independent review, unresolved-thread checks, dependency order, and release open. |
