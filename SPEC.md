...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-10 | #5162 | Couple objective elastic/Coulomb history to shaft-ball mechanics with explicit transport, termination and disjoint work. Captured-state controls and independent sticking plus rising/shrinking-cap sliding references with bounded component access pass, including componentwise force/spin/impulse/work refinement. General transition, physical and acoustic qualification remains open. |
