...
| 2026-09-08 | #5072 | Couple finite grips to all-node loaded shaft balance, response and separate-G/C spectra; share plant validation with a qualified autonomous Lyapunov decay envelope. Verify independent rod poles, transient growth, error-margin refusal, offset power and instability counterexamples. Driven/nonlinear stability, bandwidth and physical/acoustic qualification remain open. Preserve main integration with explicit fixture/dictionary types and runtime Qt fallbacks. Add private constant-affine response envelopes retaining residual forcing and separate operator/input error assumptions; analytic step-response and representability controls pass, with public APIs unchanged. |
