...
| Date       | PR         | Changes    |
| ---------- | ---------- | ---------- |
| 2026-09-09 | #5141 | Dependency-free source context package, real MCP transport, semantic boundary reviews, deterministic views and CodeMap freshness guards.; explicit-checkout hook isolation and responsive offline navigation and isolated real-SDK transport qualification. Explicit unsupported state and concurrent dependency-change rejection. CodeMap documentation reflects actual worktree freshness and graph limits; qualify fastmcp import availability in real mcp transport test. |
