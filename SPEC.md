...
| 2026-06-12 | 1.1.399 | test(golden-physics, #3391): relocate the NIST, IAPWS, flare-LHV, and calculus reference-value anchors into the existing subsystem test files named by the audit issue so the path-aware phantom guard and changed-test coverage both validate the intended scope. |
