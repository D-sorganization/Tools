...
| ---- | ------- | ------- |
| 2026-06-19 | 1.1.7781 | fix(scripting, #3701): stop calling `resource.setrlimit` at `scripting_env` import time; process resource limits now live in explicit opt-in helpers/env flags so importing the module is side-effect-free. |
