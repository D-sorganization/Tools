...
| 2026-05-02 | 1.1.122 | Restored the CI Standard coverage-policy skip for PRs that touch no Python source or Python tests, while also bootstrapping `python -m ensurepip --upgrade` before dependency installs so shared self-hosted runners recover from corrupted pip toolcache entries.                                                                                                                                                                     |
| 2026-05-02 | 1.1.121 | Hardened the CI Standard workflow bootstrap by running `python -m ensurepip --upgrade` before dependency installs so shared self-hosted runners recover from partially corrupted pip toolcache entries before test and quality-gate jobs.                                                                                                                                                                                                |
