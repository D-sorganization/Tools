...
| 2026-06-04 | 1.1.315 | fix(compatibility-tests): keep shared Python compatibility coverage importable on Python 3.10 by asserting the UTC fallback through `datetime.timezone.utc` while preserving Ruff and mypy cleanliness. |
