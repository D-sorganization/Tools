...
| 2026-09-08 | #5072 | Couple stationary finite-pose grips at arbitrary shaft nodes with consistent preload tangents, all-node equilibrium and full M/G/C/K operators; share bounded iteration with the preserved clamped solver. Verify additive rod compliance, rotating force balance and physical energy/reaction controls. Stability, grip-supported FRF/bandwidth, time evolution and impact/acoustic qualification remain open. |
