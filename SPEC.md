...
| 2026-04-27 | 1.1.103 | Resolved pyproject.toml merge-conflict markers left by an automated dependency update, restoring the canonical `ruff.toml`-based lint configuration and removing the duplicate `[tool.ruff]` block.                                                                                                                                                                                                                                                                                                                                                                 |
