...
| 2026-09-09 | #5146 | Preserve scalar typing under isolated pre-push imports and verify 46 affected controls. Review the private contact numerical foundation under #5073 with 323 Windows/Linux controls, unchanged existing API records, shared inertia/mass solve and current governance evidence. Full trajectory, physical and acoustic qualification remain under the parent epics. |
| 2026-09-10 | #5151 | Review adaptive normal-contact events and five-channel work with 386 Windows/Linux controls, independent piecewise-linear event/work refinement, shared Lie/body/contact kernels and strict domain/budget refusal. Preserve all existing API records. Physical/acoustic qualification and remaining T4 coupling stay open. |
| 2026-09-10 | #5147 | Review the private normal-contact trajectory and shared local-chart RK4 with 371 Windows/Linux controls, disjoint work/loss accounting and unchanged pre-existing API records. Contact events, friction, face modes and physical/acoustic qualification remain under #5073. |
