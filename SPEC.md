...
| 2026-09-03 | 1.18.120 | fix(a11y): add explicit `id` and `htmlFor` label associations to inputs in `ControlDashboard` and `TagInspector` to improve screen reader accessibility. |
| 2026-09-03 | 1.18.120 | fix(a11y): add explicit `id` and `htmlFor` label associations to inputs in `ControlDashboard` and `TagInspector` to improve screen reader accessibility. |
