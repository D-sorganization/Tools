...
class WrappedCanonicalLoader:
    """A loader wrapping a canonical loader to populate aliases upon execution."""
...
class RobustImportRedirector(MetaPathFinder):
    ...
    def _redirect_spec(
        ...
        """Create a redirected ModuleSpec copying attributes from canonical."""
        spec = ModuleSpec(
            fullname,
            loader,
    ...
    def find_spec(
        ...
        if fullname == "upstream_drift_tools" or fullname.startswith(
            "upstream_drift_tools."
        ):
            warnings.warn(
