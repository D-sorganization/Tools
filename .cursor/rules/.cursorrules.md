...
- **NEVER USE PLACEHOLDERS** → No `TRACKED_TASK`, `TRACKED_DEFECT`, `...`, `pass`, `NotImplementedError`, `<your-value-here>`
...
- [X] Zero TRACKED_TASK/TRACKED_DEFECT/pass in diff
...
def calculate_moment(mass, length):
    # TRACKED_TASK: implement this properly
