...
class CSVProcessorApp(ctk.CTk):
    ...
    def create_setup_and_process_tab(self, parent_tab):
        ...
        self._create_splitter(parent_tab, create_left_content, create_right_content, 'setup_left_width', 450)
    ...
    def create_plotting_tab(self, tab):
        ...
        self._create_splitter(plot_main_frame, create_plot_left_content, create_plot_right_content, 'plotting_left_width', 350)
    ...
    def populate_processing_sub_tab(self, tab):
        ...
        for i in range(1, 5):
            cb = ctk.CTkCheckBox(deriv_order_frame, text=f"Order {i}", variable=self.derivative_vars[i])
