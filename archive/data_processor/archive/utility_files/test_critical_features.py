...
def test_input_validator():
    ...
    try:
        ...
        is_valid, msg = InputValidator.validate_numeric_input(
            "123.45", min_val=0, max_val=1000
        )
        if is_valid:
    ...
    try:
        ...
        if chunks:
            ...
            if total_rows == 10000:
                ...
                print(
                    f"❌ Chunked file reading failed: expected 10000, got {total_rows}"
                )
                return False
        else:
    ...
    try:
        ...
        try:
            ...
            required_methods = [
                ...
                "converter_browse_output",
                "converter_start_conversion",
                "show_parquet_analyzer",
