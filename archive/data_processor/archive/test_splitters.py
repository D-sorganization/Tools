...
class TestSplitterApp(ctk.CTk):
    def __init__(self):
        ...
        self.layout_config_file = os.path.join(
            os.path.expanduser("~"), ".test_splitter_layout.json"
        )
        self.splitters = {}
    ...
    def create_test_tab(self, tab):
        ...
        def create_left_content(left_panel):
            ...
            ctk.CTkLabel(
                test_frame, text="Left Panel", font=ctk.CTkFont(size=16, weight="bold")
            ...
            ctk.CTkButton(
                test_frame, text="Test Button", command=self._test_button_click
        ...
        def create_right_content(right_panel):
            ...
            ctk.CTkLabel(
                test_frame, text="Right Panel", font=ctk.CTkFont(size=16, weight="bold")
            ).grid(row=0, column=0, padx=10, pady=10)
            ctk.CTkLabel(
                test_frame,
            ...
            self.width_label = ctk.CTkLabel(
                test_frame, text="Left panel width: Loading..."
            )
        ...
        splitter_frame = self._create_splitter(
            tab, create_left_content, create_right_content, "test_left_width", 300
        )
    ...
    def _test_button_click(self):
        ...
        self.status_label.configure(
            text="Test button clicked! Splitter functionality is working."
        )
