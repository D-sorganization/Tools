...
| `src/pendulum_simulator/src/double_pendulum_golf/gui/main_window.py` | # TODO(#1042): Derive from fleet ThemeManager palette when it's a hard dep. | TODO |
...
| `src/glass_bath_fea/matlab/core/applyBoundaryConditions.m` | % TODO: Implement proper face identification based on geometry | TODO |
