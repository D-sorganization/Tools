...
*   **XSS Vulnerability**: `TODO: Add DOMPurify when ready for production.` (Line 8)
*   **XSS Vulnerability**: `// TODO: Use DOMPurify to allow safe HTML tags` (Line 93)
...
*   **Backend Integration**: `// TODO: Save to database when backend is ready` (Lines 122, 169)
*   **Configuration**: `// TODO: Move fps to client-side config or use from video metadata` (Line 36)
...
*   **Missing Implementation**: `% TODO: Implement pendulum model` (Line 41)
...
*   **File**: `.github/workflows/Jules-Tech-Custodian.yml`
    ...
    *   **Status**: **Resolved**. The file currently contains `# FIX: Added ID so we can output data` and other fixes. The TODO has been removed.
...
2.  **Documentation & Policies**:
    *   `README.md`, `.cursor/rules/.cursorrules.md`, and `copilot-instructions.md` correctly list "TODO" as a banned pattern.
