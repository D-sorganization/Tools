...
| `./src/pendulum_simulator/src/double_pendulum_golf/gui/simulation_panel/_lifecycle_mixin.py` | 305 | NotImplementedError | 1 | 2 | 4 |
| `./src/pendulum_simulator/src/double_pendulum_golf/gui/simulation_panel/_lifecycle_mixin.py` | 311 | NotImplementedError | 1 | 2 | 4 |
| `./src/pendulum_simulator/src/double_pendulum_golf/gui/simulation_panel/_lifecycle_mixin.py` | 314 | NotImplementedError | 1 | 2 | 4 |
...
| `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | 430 | NotImplementedError | 1 | 2 | 4 |
| `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | 451 | NotImplementedError | 1 | 2 | 4 |
| `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | 474 | NotImplementedError | 1 | 2 | 4 |
| `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | 493 | NotImplementedError | 1 | 2 | 4 |
| `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | 512 | NotImplementedError | 1 | 2 | 4 |
...
|---|---|---|---|
| 1 | `./src/shared/python/model_generation/explorer/model_explorer.py` | class ModelFileSelectionRequiredError(NotImplementedError): | 5/3/4 |
| 2 | `./tests/tools/test_matlab_quality_utils.py` | Path("script.m"), "% TODO: fix this", 5, issues | 3/5/3 |
| 3 | `./src/tools/quality_utils.py` | (re.compile(r"NotImplementedError"), "NotImplementedError placeholder"), | 3/2/4 |
| 4 | `./scripts/legacy_tools/code_quality_check.py` | (re.compile(r"NotImplementedError"), "NotImplementedError placeholder"), | 3/2/4 |
...
| 13 | `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | - ``Golfer``: **no NumPy fallback** — raises ``NotImplementedError`` on all meth | 1/2/4 |
| 14 | `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | # Golfer requires the native library — raises NotImplementedError otherwise. | 1/2/4 |
| 15 | `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | M = golfer.mass_matrix(q)  # raises NotImplementedError if no native lib | 1/2/4 |
| 16 | `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | raise NotImplementedError( | 1/2/4 |
| 17 | `./src/pendulum_simulator/pendulum-core/python/physics_native.py` | raise NotImplementedError( | 1/2/4 |
