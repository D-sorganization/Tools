...
|---|---|---|---|
| 1 | `src/tools/matlab_quality_utils.py` | """Check for TRACKED*TASK, TRACKED_DEFECT, HACK, XXX, and placeholders.""" | 3/2/3 |
...
| 5 | `src/tools/quality_utils.py` | re.compile(r"<[^<>]\_TRACKED_TASK[^<>]*>", re.IGNORECASE), | 3/2/3 |
