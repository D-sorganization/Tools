...
pie title Completion Status
    "Impl Gaps (Critical)" : 5415
    "Feature Requests (TRACKED_TASK)" : 6
    "Technical Debt (TRACKED_DEFECT)" : 57
    "Doc Gaps" : 1
```
...
pie title Issues by Module
    "shared" : 1600
    "data_processing" : 832
    "pendulum_simulator" : 742
    "solar_system_model" : 307
    "rotation_converter" : 217
```

## Critical Incomplete (Top 50)
| File | Line | Type | Impact | Coverage | Complexity |
|---|---|---|---|---|---|
| `src/shared/python/data_processing/processor.py:52` |     def __init__(self) -> | Stub | 5 | 3 | 4 |
...
| `src/shared/python/gui_launcher/registry.py:39` |     def __init__(self) -> | Stub | 5 | 3 | 4 |
...
|---|---|---|---|
| `src/tools/matlab_quality_utils.py` | 323 | """Check for TRACKED_TASK, TRACKED_DEFECT, HACK, XXX, and placeholders.""" | XXX |
| `src/tools/matlab_quality_utils.py` | 332 | (r"\bHACK\b", "HACK comment found"), | HACK |
| `src/tools/matlab_quality_utils.py` | 333 | (r"\bXXX\b", "XXX comment found"), | XXX |
