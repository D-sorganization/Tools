...
- Severity: high
- Problem: Potential secret-like assignments found in: src/media_processing/video_processor/apps/web/lib/**tests**/csrf.test.ts; tests/test_integration_test_helpers.py
