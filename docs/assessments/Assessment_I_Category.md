...
| ----- | -------------- | -------- | --------- | ---------------- |
| I-001 | Critical | Style | All | 1420 print statements | Poor hygiene | Use logging | M |
| I-002 | Major | Types | All | 12523 mypy errors | Missing types | Add type hints | L |
| I-003 | Minor | Quality | All | 475 TODOs | Unfinished work | Complete TODOs | S |
