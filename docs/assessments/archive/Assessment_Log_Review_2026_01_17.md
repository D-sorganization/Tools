...
The `unit_converter` sub-project is operating under a set of rules that reference deleted infrastructure. This suggests the "Shadow CI/CD" identified in the previous review was technically removed (files deleted), but the _policy_ attempting to legitimize it remains.
