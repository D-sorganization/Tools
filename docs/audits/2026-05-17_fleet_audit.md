...
| 22  | Gasification_Model | [#3675](https://github.com/D-sorganization/Gasification_Model/issues/3675) PyQt chatbot_dialog.py module missing — only stale **pycache** remains                                                                                               | P0  | OPEN                  | Either remove cache or restore module                                                                                         |
...
| Tools                 | #2798 | COMPLETED   | 2026-05-15T18:47 | [Sidekick][Bug] ai/**init**.py broken import chain forces tests to use sys.modules bootstrap                                                           |
...
| UpstreamDrift         | #5478 | COMPLETED   | 2026-05-16T08:14 | Broken **init**.py re-exports: config and data_io fail at import time                                                                                  |
...
| UpstreamDrift         | #5473 | NOT_PLANNED | 2026-05-16T01:34 | [review] [Reviewer (chatgpt-codex-connector[bot])] Feedback on src/api/**init**.py:None                                                                |
| UpstreamDrift         | #5472 | NOT_PLANNED | 2026-05-16T09:12 | [review] [Reviewer (chatgpt-codex-connector[bot])] Feedback on src/api/**init**.py:None                                                                |
...
| Gasification_Model    | #3675 | COMPLETED   | 2026-05-16T05:41 | PyQt chatbot_dialog.py module missing — only stale **pycache** remains                                                                                 |
