...
- **Next step:** Fourteen serial profiled GUI controls pass (224.51 s), with sampling lag and repaint/deletion stacks that do not explain full-suite losses. GitHub CLI recovered at 08:56 UTC; issuecomment-5599216206 publishes the evidence. Checkpoint f788ca612 passed normal commit hooks; complete push hooks and keep #5114 open until full four-worker qualification succeeds. No test deadlines or physical calculations changed.
