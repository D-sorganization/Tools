...
- **Next step:** Publish merge 96ba67aa6 through normal push hooks; inventory freshness, pinned Ruff (3,787 files) and every normal merge hook pass. Main integration preserves golf source/tests and incorporates the previously reviewed signal repair. Continue explicit operating-model/residual-forcing, time-varying, transient/bandwidth and nonlinear work. UD #9841 is published with protected CI pending; #8920/#8556 retain physical gates. Integrate classifier #5103 before combined delivery.
