...
- **Next step:** Main integration is published at 5e4d82314 through all normal hooks. Residual-forced affine response is published at d5d1e6537 through all normal hooks. The new constant gripped operating-model adapter passes 57 Windows and 824 Linux golf/signal/API tests; all nine final gates and repository Ruff pass; normal publication remains. See AFFINE_RESPONSE.md. Main integration preserves golf source/tests and incorporates the previously reviewed signal repair. Continue explicit operating-model/residual-forcing, time-varying, transient/bandwidth and nonlinear work. UD #9841 merged as 28d9bf79e and #9830/#9842 are closed; #8920/#8556 retain physical gates. Integrate classifier #5103 before combined delivery.
