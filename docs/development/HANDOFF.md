...
- Next: qualify an independent friction reference across first contact and stick/slide transitions. Last published HEAD is a22f3f1cbda7b0107a4f59730ab19a04ed26b84d; Standard CI run34460212232 remains queued for that exact head, not the pending release-reference commit. Check the same run at a natural checkpoint; do not restart merely because observation is delayed. Earlier cb Python3.11 zero-gap release timed out at60s. General transition/componentwise, mesh/mode, protected review and eventual main/consumer qualification remain open. Keep#5160/#5073/#5074/#5068, UD#9700 and Affine#4253 open for numerical and physical/acoustic requirements.
