...
- Local `feat/4270-flight-bounce-execution` starts from exact clean published
  Tools #4357 head `c492b52f9f7615c5bc38e780965167cc8f64327c`.
...
- This is an unpushed, `not_released` local candidate. PyQt6/React UI,
