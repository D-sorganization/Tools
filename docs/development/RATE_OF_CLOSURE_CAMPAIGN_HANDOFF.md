...
## 2026-08-11 Final local #4298 camera/ground reconstruction

- PR `#4298` retains branch `feat/4284-camera-snap-tracking` and declared base
  `feat/4199-wind-workflow` at exact published commit
  `51033696634c624f7c92c3822d98a66875ff90a0`.
- Published camera child `35d04ee4bb4d74045594d3ef0b274e2b09cc5a3b`
  was normally merged first with unpublished native orthographic-axis polish
  `37fa7f86dcdd7bf4225da34286e39f16837caba6`, producing intermediate
...
- Stale held candidate `0eb576315498d4576b553e1ccc631345d9f6b23e` is
  excluded from ancestry. The only production conflict resolves wholly to the
  validated split kinetics façade from the refreshed parent; camera/native
  polish and flight-ground behavior remain additive.
- SPEC `1.16.26` records this local composite. No push, PR mutation, retarget,
  parent rewrite, force-push, or release claim is made. Protected exact-head
  CI, review, and publication remain separate gates.
- Final local gates passed: 1,109 Python/PyQt/flight/ground tests; TypeScript,
  zero-warning ESLint, 111 React files/675 tests, four desktop/constrained-HiDPI
  Playwright camera tests, and a 194-module build; Rust format, 137
  `tools-core` tests, 12 `swing-core` tests, and warning-denied Clippy; pinned
  Ruff/MyPy, Bandit, module-size, changed-file policy/test-contract,
  manifest/schema, docs-governance, and whitespace checks. PyQt qualification
  was offscreen; protected and newly rendered native evidence remain separate.

Status verified 2026-08-10. This isolated integration is published as draft
[PR #4217](https://github.com/D-sorganization/Tools/pull/4217). No source PR
branch was rewritten.

## 2026-08-11 camera composite acquires native orthographic polish

- Exact published camera child
  `35d04ee4bb4d74045594d3ef0b274e2b09cc5a3b` is first and exact unpublished
  native polish `37fa7f86dcdd7bf4225da34286e39f16837caba6`
  second in a normal merge. PR #4298's declared base remains
  `feat/4199-wind-workflow`.
- The polish hides only the depth display axis in each exact orthographic
  preset and restores every axis for isometric/manual orbit. All camera state,
  limits, tracking, zoom, physics, and web behavior remain unchanged.
- This is an unpublished intermediate topology commit. Refreshed #4288 must be
  merged next and the complete composite must pass fresh camera/PyQt, React,
  Playwright, Rust, static, and governance gates.
...
## 2026-08-11 refreshed ground-contract parent propagated into flight transfer

- Open PR `#4288` remains on actual branch
  `feat/4269-flight-ground-transfer` over `feat/4268-ground-contract`. Exact
  published child `3e6e418f98856162420dcb3f5f13dedd48d40439`
  is first and exact refreshed parent
  `7a6f31b6cb36e05f903c591e207480d36f491c4d` second in a normal no-ff merge.
- Qualified flight-to-ground transfer across Python, TypeScript, Rust, PyO3,
  and WASM remains intact, including signed terminal angular state, physical
  sphere/terrain contact evidence, fixtures, and strict cross-runtime records.
- Historical merged PR `#4283` remains pinned at head
  `9bbb98e16e435a0d4c74153b909f2ebfefbbce7a` and merge SHA
  `c1827bbdc50a6e11cc475db2636b4e47a4c15416`. Current live dependency heads
  are recorded separately without reopening or rewriting historical PRs.
- Handoff histories remain additive, SPEC advances uniquely to `1.16.25`, and
  the manifest remains strict and unreleased. Publication, protected CI,
  independent review, approval, and release remain open.
- Local evidence passes 302 focused Python/PyQt tests with six explicit
  optional native-wheel parity skips covered by 137 passing `tools-core` Rust
  library/transfer/wire tests. Rust fmt/Clippy, 100 React tests across 12 files,
  type-check/lint/audit, the 189-module build, Ruff on 13 exact-parent Python
  paths, MyPy on nine production paths, Bandit, manifest/schema, docs,
...
## 2026-08-11 refreshed live capability carrier propagated into ground contract

- Open PR `#4285` remains `feat/4268-ground-contract` over
  `feat/4197-capability-observer`. Exact published child
  `d36551cead67e2544cf185584bff4d070ee663b3` is merged first and exact
  refreshed live parent `0179abbdd8c0166f125d87e4d6ab47aeca15df40`
  second by a normal no-ff merge.
- The strict flight-to-ground schemas, fixture, migrations, adapters,
  dependency, and explicit fail-closed unimplemented-physics boundary remain
  unchanged. Refreshed capability/wind ancestry and the typed observation-
  export boundary merge without production/test conflict.
- Historical PR `#4283` stays merged at head
  `9bbb98e16e435a0d4c74153b909f2ebfefbbce7a` and merge SHA
  `c1827bbdc50a6e11cc475db2636b4e47a4c15416`. Its preserved live branch is a
  dependency carrier, not a reopened or rewritten PR.
- Handoff histories remain additive, SPEC advances uniquely to `1.16.24`, and
  the manifest remains strict and unreleased. Publication, protected CI,
  independent review, approval, normal #4288 propagation, and release remain
  open.
- Local evidence passes 256 focused Python/PyQt tests, 75 focused React tests
  across nine files plus type-check/lint/build/audit, and 12 `swing-core` Rust
  tests plus workspace fmt and warning-denying Clippy. Pinned Ruff covers all
  27 exact-parent Python paths, MyPy covers 20 production paths, and Bandit,
  manifest/schema, docs, 400-line size, changed-policy, minimum-test,
  exact-base assertion, and diff gates pass.
