...
267 regression controls and nine later sticking/sliding reference checks pass.
...
- T4 #5073 continues on feat/5073-load-history; review child#5153 / PR#5154 adds prescribed force/couple histories (406 Windows/Linux controls pass); child #5151 is PR#5152 and passes386 Windows/Linux controls at tree4e1b19810; later isolated typing repair passes15 affected controls and both mypy modes. Temporal child #5147 is PR #5149. Active leases/presence are on the fleet board; final consumer and physical/acoustic qualification remain pending.
...
| #5158 / issue #5114            | Serial Club Tester candidate in fix/issue-5114-rate-isolation; all 16 shard contracts, complete partition and three unchanged GUI/model tests pass. Linux qualification pending; see DL-#5114 and canonical HANDOFF.md.                                                                                                                                                                |
