...
| #4800 | Putting simulator parity. Open. P2 (#4809) delivered green-surface heightfields, 2-D surface roll, Holmes/Penner capture, and the `swing_sim.green_surface/1` wire (planar limit bit-identical, TS twins). P1/P3-P9 remain; P9 adapts the wire to UpstreamDrift's `putting_green`.                              |
