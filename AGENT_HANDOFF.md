...
| CI issue #5114                 | Serial Club Tester candidate in fix/issue-5114-rate-isolation; all 16 shard contracts, complete partition and three unchanged GUI/model tests pass. Linux qualification pending; see DL-#5114 and canonical HANDOFF.md.                                                                                                                                                                |
