...
- T3 #5072 publishes moving-grip kinematics at `0d45c4b7f`. A separate finite-coordinate grip force law now shares existing energy algebra and retains both physical power ports; 634 Linux golf/API tests pass (two optional CAD skips), plus 37 focused grip tests. `FINITE_GRIP_RESPONSE.md` derives the law, independent energy-gradient/observer controls and limits. Loaded balance/tangent, time evolution and stability remain open; final publication pending, PR not created.
