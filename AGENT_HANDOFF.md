...
base `feat/4268-ground-contract`. This checkout incorporates exact local parent
head `2025b504f` through a normal merge; neither branch was rebased, retargeted,
