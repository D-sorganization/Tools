...
- T3 #5072: main integration is published at 5e4d82314 and residual-forced affine response at d5d1e6537, through all normal hooks. New constant gripped operating models retain residuals, geometry/frame and source IDs and share scaling with frozen spectra. Tests pass: 57 Windows and 824 combined Linux golf/signal/API (two optional CAD skips); all nine final gates and repository Ruff pass; normal publication remains. See CONSTANT_GRIPPED_MODEL.md and PROGRESS.md. Classifier #5103 is still required; all physical/acoustic and moving/nonlinear/bandwidth gates remain open. UD #9841 merged as 28d9bf79e; #9830/#9842 are closed.
