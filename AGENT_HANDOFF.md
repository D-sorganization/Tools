...
- #4142 R10.3 protected-merged through PR #4757 as
  ...
  the inherited fail-closed 3-source by 4-adapter matrix. Focused local gates pass; the exact CI repair retains UpstreamDrift's BunkerShot/pendulum package paths and prevents repo-scoped checkout auth from breaking the public RustSec audit. Protected CI and remote-main evidence remain.
