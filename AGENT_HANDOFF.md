...
- #4142 R10.3 protected-merged through PR #4757 as
  ...
  the inherited fail-closed 3-source by 4-adapter matrix. Focused local gates pass; the exact CI repair retains UpstreamDrift's imported BunkerShot, double-pendulum, and parent package-marker paths in the shallow contract checkout. Protected CI and remote-main evidence remain.
