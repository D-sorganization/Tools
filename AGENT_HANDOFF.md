...
- T3 #5072 publishes finite-grip response at `28c45eb15` through all normal hooks. Shared energy algebra and dual physical ports pass 634 Linux golf/API tests (two optional CAD skips) and 37 focused grip tests. `FINITE_GRIP_RESPONSE.md` records the derivation/limits; `DATA_CANDIDATES.md` adds measured KIT hand-arm candidates, not inspected payloads or golf validation. Loaded balance/tangent, time evolution and stability remain open; PR not created.
