...
- T3 #5072 publishes main integration 5e4d82314, residual affine bounds d5d1e6537 and explicit constant gripped models 36aae1d578 through all normal hooks. New finite-time affine motion reuses the same plant/input/scaling and retains neutral, defective and growing states; no physical stability is inferred. Initial TDD and underflow RED are repaired: 88 focused Windows tests and actual mypy/Ruff pass. All 860 Linux golf/signal/API tests pass (two optional CAD skips); all nine gates and repository Ruff pass. Normal publication remains; see AFFINE_TRANSIENT.md and PROGRESS.md. UD #9841 merged as 28d9bf79e; #9830/#9842 are closed.
...
- T3 lease: codex/session impact-acoustics-01a07d8a-shaft5072 until 2026-09-09T06:51:45Z. Next: finish transient validation, then modal/mesh/FRF bandwidth, moving/nonlinear/contact/acoustic qualification. Full requirements and evidence: docs/development/impact-acoustics/PROGRESS.md.
