...
- Classifier #5103 integration is published as 5c5fa16b9 through every normal hook, remote verified. Scientific source/tests merged unchanged; 217 integration tests, actual mypy, root Ruff and all nine gates pass. Later main 0f2dfe3fd (mocap #5118) is not integrated yet; preserve its other-task scope.
