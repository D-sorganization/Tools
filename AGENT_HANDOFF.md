...
- T3 #5072: loaded M/G/K published at `78253741f`; private frozen spectra pass 22 final Windows tests. `FROZEN_SPECTRA.md` records scaling, both state/quadratic residuals, gyroscopic stabilization and defective/circulatory controls. Final broader Linux run: 589 passes, two optional CAD skips. Stability, moving work, loaded grip/head and full FRF remain open; PR not created.
