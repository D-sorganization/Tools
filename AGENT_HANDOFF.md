...
- OpenCV4.13/5 numerical tests pass. Integrating main2c9a8d6c9 (merged impact #5133); rerun numerical checks and CI. Earlier rate shards timed out; private Gasification checkout remains unverified. UpstreamDrift#9917/#9919/#9918 merged; bag/wizard/calibration goals continue. See `docs/development/HANDOFF.md`.
