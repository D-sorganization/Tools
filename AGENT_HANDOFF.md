...
- T3 #5072 publishes Galerkin reduction 5ea22307d through all normal hooks (81 combined Windows tests; 888 Linux regression passes plus final overflow control). New independent bending/shear/rotary continuum checks and joint mesh/modal error separation pass all 12 Windows cases in 86.44 s. Production science/APIs are unchanged. All 21 Linux bending/axial/API checks pass in 294.88 s (three plugin warnings); final inventory/publication remain; see BENDING_CONTINUUM.md. This synthetic control reaches 40 rad/s, not acoustic-band qualification. UD #9841 merged as 28d9bf79e; #9830/#9842 are closed.
...
- UpstreamDrift #9841 merged: adaptive reference diagnostics preserve strict endpoint budgets; Bioptim/Casadi 3.6.7 qualification has 21 real consumer/import/dependency passes. The unsuccessful 3.8 OCP case remains explicit. No physical claim or relaxed threshold; #8920/#8556 remain parameter/data gates.
- T3 lease: codex/session impact-acoustics-01a07d8a-shaft5072 until 2026-09-09T08:36:26Z. Next: publish bending verification, then continuous-band and rotating/moving/nonlinear/contact/acoustic qualification. Full requirements: docs/development/impact-acoustics/PROGRESS.md. Classifier #5103 head be38a827a is mergeable with CI running; #5114 additional targeted Python 3.12 tests pass without a source diagnosis.
