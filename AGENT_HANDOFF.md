...
- T3 #5072: `feat/5072-prestressed-shaft`, based on T2 `2f975d06e`; commit `SELF`, PR not created; tensile FEM, stationary shaft/head/grip and distributed rotating transport implemented; 464 golf/API tests pass (two optional CAD skips), including objective section kinematics, elastic virtual work and the complete internal energy tangent. Loaded-state/work/FRF qualification remains open.
