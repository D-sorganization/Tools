...
def main():
    ...
    if success_count == len(packages):
        print("✅ All dependencies installed. You can now use all ML data formats (Parquet, HDF5, Feather, Pickle).")
    else:
        print("⚠️  Some dependencies failed to install. Some ML data format features may not work properly.")
