...
## [1.20.0] - 2026-09-20 (minor bump)

### Changes

#### Breaking changes

- feat(launch-monitor)!: extract shared GSPro Open Connect v1 codec (#5228) (#5244)

#### Features

- feat(flight): reconcile Rust and Penner lift models, benchmark carries, and document wind (#4252) (#5265)
- feat(rate-ui): native file commands and workspace persistence (#4220) (#5258)
- feat(wedge-ui): advanced delivery metrics cards, linear waterfall, and 3D visualization (#4162) (#5268)
- feat(conventions): side-by-side comparison workspace and full coverage matrix (#4186) (#5267)
- feat(ops): content-based visual baseline gate and main re-baseline (#4918) (#5269)
- feat(golf-club): add measured grip impedance dynamics and passivity (#5072) (#5259)
- feat(release): Rate of Closure release gate runner and campaign state transition (#4201, #4922) (#5273)
- feat(vibroacoustics): implement transient vibroacoustic radiation and field solver (#5074) (#5261)
- feat(putting): accuracy validation harness and rig protocol (#5221) (#5270)
- feat(impact): implement non-spherical oblique contact and moving COP (#5073) (#5260)
- feat(putting-monitor): recorded-putt replay corpus regression test suite (#5222) (#5256)
- feat(camera): export FrameSource ABC lazily and fix test_gui race condition (#5227, #5237) (#5239)
- feat(putting_launch_monitor): launcher registration, tools.json, README catalogue entry (#5220) (#5226)
- feat(putting_launch_monitor): PyQt6 window with live view, calibration wizard and GSPro panel (#5225)
- feat(putting_launch_monitor): camera putting launch monitor for GSPro + shared camera layer (#5218) (#5224)
- feat(variation): detect explicit planted design matrix substitution (#4462) (#5192)
- feat(camera): re-land camera controls and preference persistence (#4961) (#5190)
- feat(swing_sim): resolve impact study wire boundary gaps and qualification truthfulness (IA-T6) (#5075) (#5178)
- feat(impact): couple objective friction to shaft-ball trajectories (#5162)
- feat(mocap): apply measured ruler scale to established camera layouts (#5169)
- feat(vibroacoustics): retain calibration identity and shared uncertainty (#5159)
- feat(acoustics): preserve H1 phase and explicit spectral support (#5156)
- feat(impact): prescribe time-varying shaft forces and couples (#5154)
- feat(impact): integrate adaptive normal contact events and work (#5152)
- feat(impact): integrate normal contact trajectories with explicit work (#5149)
- feat(impact): add work-conjugate shaft and ball contact foundation (#5146)
- feat(context): provide verified local module and integration context (#5141)
- feat(mocap): deliver reference CLI and service endpoints (#4727) (#5121)
- feat(mocap): solve camera layouts from identified reference placements (#5140)
- feat(golf-club): add finite-rotation shaft dynamics and explicit model inputs (#5133)
- feat(mocap): deliver temporal reconstruction and biomechanical mapping (#4726) (#5118)
- feat(swing_sim): add versioned impact study wire and truthful application surface (IA-T6) (#5083)
- feat(swing_sim): add vibroacoustic measurement ingestion (IA-T5) (#5084)
- feat: add verified full-tensor impact reference and acoustic research plan (#5077)
- feat(mocap): deliver pose backend adapters and fail-closed licensing (#4715) (#5076)
- feat(mocap): deliver camera extrinsic calibration and layout alignment (#4721) (#5066)
- feat(mocap): deliver camera intrinsic calibration and qualification (#4714) (#5064)
- feat(mocap): deliver synchronization analysis and crash-safe recording (#4718) (#5059)
- feat(mocap): deliver camera acquisition protocol and reference drivers (#4713) (#5056)
...
- fix(tooling): bump mirrors-mypy pre-push hook to v1.15.0 for numpy compatibility (#5223) (#5254)
- fix(tests): resolve relative fixture imports and calibrate web open budget (#5210) (#5214)
- fix(product): remove phantom tauri scripts from web package.json (#4919) (#5208)
- fix(variation): align and pin flight-model policies across runtimes (#4457) (#5205)
- fix(variation): establish deterministic explicit parity gate and clarify sanity band (#4456) (#5203)
- fix(web): stabilize plot canvas aspect ratio against resize oscillation (#5177) (#5179)
- fix(test): register validates_physics marker and guard folder_tool log path mkdir (#5176)
- fix(ci): add libdbus-1-3 to Rate PyQt container system dependencies (#5135) (#5173)
- fix(ci): isolate coupled Club Tester tests within the rate shard (#5158)
- fix(ci): route trusted PyQt renderer job to a Docker-guaranteed runner (#5108) (#5108)
- fix(constants, #3994): import canonical gravity/gas constants with standalone fallbacks (#5107) (#5107)
- fix(manual): detect Python scientific imports without executing source (#5103)
- fix(acoustics): reject invalid signals and undefined spectral estimates (#5106)
- fix(golf-club): qualify coupled impact termination and energy (#5082)
- fix(ci): isolate the Rate PyQt renderer across runner hosts (#5090)
- fix(impact): report contact completion and refuse to export unfinished contact (#5088)
- fix(watcher): verify debounce with deterministic timestamps (#5097)
- fix(impact): audit contact energy independently instead of zeroing the residual (#5079)
- fix(sidekick): enforce glass conductivity provider contracts and explicit fallback policy (#5062) (#5080)
- fix(theme): restore the 60-token ThemeColors derivation pipeline (#5063) (#5078)
- fix(ai-gui): restore the launcher-owned Sidekick action bridge (#7209) (#5065)
- fix(ai): block dangerous arguments in ShellTool to prevent command injection (#5057)
- fix(shared, #5048): keep alias gating correct in a flattened install (#5049)
- fix(tests, #4933): unquarantine folder tool UI and legacy test suites (#5036)
- fix(tests, #4933): unquarantine 10 pendulum simulator test modules (#5035)
...
- perf(shared): resolve codemap hashing once and cut realtime transport per-message syscalls (UpstreamDrift#8942) (#5081)

#### Other

- 🎨 Palette: Improve keyboard accessibility for file import (#5280)
- build(deps): bump ruff from 0.16.6 to 0.16.8 (#5250)
- docs: sync fleet-managed agent sections from Repository_Management (#5285)
- test(rate-of-closure): re-approve launch_monitor_analytics visual baseline from trusted run (#5284) (#5286)
- ⚡ Bolt: Use single-pass loop for bestCosts to prevent stack overflow and reduce GC pressure (#5279)
- build(deps): update playwright requirement from >=1.61.0 to >=1.63.0 (#5249)
- ⚡ Bolt: Use native slice() instead of array spread for sorting (#5278)
- build(deps): bump matplotlib from 3.11.1 to 3.11.2 (#5248)
- build(deps-dev): update uvicorn requirement (#5251)
- build(deps): bump pypdf from 6.18.0 to 6.19.0 (#5252)
- docs: sync fleet-managed agent sections from Repository_Management (#5253)
- ⚡ Bolt: Use single-pass loop for mesh extents to prevent stack overflow (#5247)
- 🎨 Palette: Add keyboard focus visible ring styles to missing buttons (#5246)
- ⚡ Bolt: Use single-pass loop for energy balance check to prevent stack overflow and GC pressure (#5245)
- 🎨 Palette: Native form submission for Custom Units (#5243)
- ⚡ Bolt: Use single-pass loops for bounds calculations to prevent stack overflow (#5242)
- ⚡ Bolt: Use single-pass loops for calculating scale from eigenvalues in variationDispersionMath (#5231)
- ⚡ Bolt: Replace Math.min(...array) and .indexOf() with single-pass loops (#5235)
- ⚡ Bolt: Use single-pass loops for bounds to prevent stack overflow and GC pressure (#5233)
- 🎨 Palette: Add focus-visible states for keyboard accessibility (#5234)
- 🎨 Palette: Add focus states to FunctionGenerator buttons (#5232)
- ⚡ Bolt: Use single-pass loop for math max to prevent stack overflow and GC pressure (#5230)
- ⚡ Bolt: Use single-pass loops in screw analysis to prevent GC pressure (#5217) (#5217)
- docs(putting_launch_monitor): turnover document for completing epic #5218 (#5229)
- ⚡ Bolt: Use single-pass loops for marginal counts in distribution matrix to prevent call stack issues (#5213)
- ⚡ Bolt: Use single-pass loop for trajectory apex to prevent stack overflow (#5216)
- chore(infra): prune unused compose services, update helm doc, sync package-lock (#4919) (#5209)
- ⚡ Bolt: Use single-pass memory views for optimizer constraints concatenation (#5201)
- 🎨 Palette: Add keyboard focus indicator to file inputs (#5200)
- ⚡ Bolt: Optimize telemetry array allocation to reduce GC pressure (#5202)
- build(deps): bump types-pyyaml from 6.0.12.20260815 to 6.0.12.20260906 (#5199)
- build(deps): bump mypy from 1.13.0 to 2.3.1 (#5198)
- build(deps): bump ruff from 0.16.5 to 0.16.6 (#5197)
- build(deps): bump pypdf from 6.16.2 to 6.18.0 (#5196)
- build(deps): bump types-requests from 2.33.0.20260518 to 2.33.0.20260906 (#5195)
- ⚡ Bolt: Use single-pass loop for vendors map to prevent stack overflow and GC pressure (#5193)
- 🎨 Palette: Improve keyboard focus visibility on file upload buttons (#5194)
- test(rate_of_closure): resolve ground fixture cluster parity decisions (#4560) (#5189)
- test(morris): anchor elementary effects to closed-form analytical test oracle (#4458) (#5191)
- docs(rate-of-closure): remove phantom Tauri build documentation (#4919) (#5188)
- ⚡ Bolt: Optimize bounds calculation in VariationArcDrawing (#5181)
- docs: sync fleet-managed agent sections from Repository_Management (#5186)
- ⚡ Bolt: Replace Math.max(...map()) with single-pass loops (#5183)
- docs(architecture): adopt maintainable Mermaid C4 architecture-map contract (#1614) (#5174)
- ⚡ Bolt: [performance improvement] Replace Math.max spread in NeuralModelLabPanel (#5167)
- ⚡ Bolt: [performance improvement] Replace array spread in bounds calculation (#5164)
- ⚡ Bolt: Avoid spread operator for large array bounds (#5166)
- ⚡ Bolt: Optimize array bounds calculations (#5093)
- ⚡ Bolt: Replace Math.max(...map) chains with single-pass loops (#5123)
- Added focus-visible and focus-within states to TorqueProfilePanel interactive elements. (#5165)
- 🎨 Palette: Refine keyboard focus rings to use focus-visible and consistent color tokens (#5125)
- test(rate_of_closure): add Python consumers for the three TypeScript-only fixtures (#5112)
- docs: sync fleet-managed agent sections from Repository_Management (#5150)
- test(morris): anchor R13.6 suggested drafts to a shared Python artifact (#5113) (#5113)
- refactor(ui): move FunctionGeneratorWidget to shared.python.ui; import it explicitly in SPS (#3993) (#5110)
- ⚡ Bolt: Replace Math.min/max spread in ScalarEnsembleScatter with single-pass loop (#5124)
- docs(handoff): record 2026-09-08 wave-2 Tools PR dispositions (#5116)
- refactor(theme, #3992): source app stylesheets and palettes from canonical Catppuccin module (#5109)
- ci(contracts): initialize UpstreamDrift vendor/ud-tools pin in downstream lane (#5086)
- docs(manual, #4730): enforce governed completion-audit handoff and maintenance contract (#5055)
- docs(manual, #4728): enforce immutable public publication projection contract (#5054)
- docs(manual, #4725): enforce render, semantic, and accessibility QA with zero sampling (#5053)
- docs(manual, #4723): enforce executable calculation freshness, fixtures, and reverse-impact gate (#5051) (#5051)
- ⚡ Bolt: Replace array spreads and chained maps with single-pass loops to reduce GC overhead (#5046)
- docs(manual, #4720): publish calculation exemplar contracts and update docs-governance triggers (#5050)
- ⚡ Bolt: replace array spread with mutable push in candidate loops (#5045)
- docs(manual, #4717): enforce full derivation-family formula traceability contract (#5047)
- ⚡ Bolt: Replace Math.max spread in PuttingVisuals (#5044)
- docs: relocate the 2026-03-09 adversarial code review docx from Repository_Management (#5039)
