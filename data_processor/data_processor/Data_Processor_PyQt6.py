...
from threads import ProcessingThread, ConversionThread, FolderProcessingThread
...
class CSVProcessorAppPyQt6(QMainWindow):
    ...
    def process_files(self):
        ...
        self.processing_thread = ProcessingThread(self.data_files, self.settings, self.output_folder, process_single_csv_file)
