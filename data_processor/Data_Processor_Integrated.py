...
try:
    import sys
    folder_tool_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'folder_tool')
    sys.path.append(folder_tool_path)
    from Folders_Tool_r0 import FolderProcessorApp as OriginalFolderProcessorApp
