...
common_types = ['null', 'bool_', 'int8', 'int16', 'int32', 'int64', 
                'uint8', 'uint16', 'uint32', 'uint64', 
                'float16', 'float32', 'float64', 
                'timestamp', 'date32', 'date64', 'time32', 'time64', 'duration',
                'binary', 'string', 'large_binary', 'large_string',
...
class MockCSVProcessorApp:
    ...
    def create_setup_and_process_tab(self, tab): pass
    def create_plotting_tab(self, tab): pass
    def create_plots_list_tab(self, tab): pass
    def create_dat_import_tab(self, tab): pass
    def create_help_tab(self, tab): pass
    def _on_closing(self): pass
    def _on_window_configure(self, event): pass
    def _load_plots_from_file(self): pass
    def grid_rowconfigure(self, *args): pass
    def grid_columnconfigure(self, *args): pass
    def _create_splitter(self, *args): return MagicMock()

mock_r0.CSVProcessorApp = MockCSVProcessorApp
sys.modules['Data_Processor_r0'] = mock_r0

# Now import the class under test
from Data_Processor_Integrated import IntegratedCSVProcessorApp, SplitConfig, SplitMethod, FileFormatDetector
...
class TestIntegratedCSVProcessorApp(unittest.TestCase):
    ...
    def test_parquet_analyzer(self, mock_pq):
        ...
        mock_col.statistics = None # Disable stats to avoid MagicMock in f-string if format is used
        ...
        with patch('Data_Processor_Integrated.ctk.CTkToplevel'), \
             ...
             patch('Data_Processor_Integrated.ctk.CTkTextbox') as mock_textbox_cls, \
