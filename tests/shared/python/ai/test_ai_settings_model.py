...
_PACKAGE_STUBS: list[tuple[str, str | None]] = [
    ...
    ("src.shared.python.ai.gui", "src/shared/python/ai/gui"),
    ("src.shared.python.config", None),
    ("src.shared.python.config.environment", None),
...
_env_stub = sys.modules["src.shared.python.config.environment"]
